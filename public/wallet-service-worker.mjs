...
function Kf(t) {
  const e = (r) => t().update(Za(r)).digest(),
    n = t()
  return (e.outputLen = n.outputLen), (e.blockLen = n.blockLen), (e.create = () => t()), e
}
function Xa(t = 32) {
  if (fr && typeof fr.getRandomValues == 'function') return fr.getRandomValues(new Uint8Array(t))
  if (fr && typeof fr.randomBytes == 'function') return Uint8Array.from(fr.randomBytes(t))
...
let oh = class extends Df {
  ...
  process(e, n) {
    for (let g = 0; g < 16; g++, n += 4) kn[g] = e.getUint32(n, !1)
    for (let g = 16; g < 64; g++) {
      const m = kn[g - 15],
        b = kn[g - 2],
        U = Ye(m, 7) ^ Ye(m, 18) ^ (m >>> 3),
        T = Ye(b, 17) ^ Ye(b, 19) ^ (b >>> 10)
      kn[g] = (T + kn[g - 7] + U + kn[g - 16]) | 0
    }
    let { A: r, B: o, C: s, D: c, E: u, F: f, G: h, H: y } = this
    for (let g = 0; g < 64; g++) {
      const m = Ye(u, 6) ^ Ye(u, 11) ^ Ye(u, 25),
        b = (y + m + eh(u, f, h) + rh[g] + kn[g]) | 0,
        T = ((Ye(r, 2) ^ Ye(r, 13) ^ Ye(r, 22)) + nh(r, o, s)) | 0
...
const Qa = /* @__PURE__ */ BigInt(0),
  ya = /* @__PURE__ */ BigInt(1)
function vr(t) {
  return t instanceof Uint8Array || (ArrayBuffer.isView(t) && t.constructor.name === 'Uint8Array')
}
function Ja(t) {
  if (!vr(t)) throw new Error('Uint8Array expected')
}
function so(t, e) {
...
function ao(t) {
  if ((Ja(t), Vf)) return t.toHex()
  let e = ''
  for (let n = 0; n < t.length; n++) e += ih[t[n]]
  return e
}
const sn = { _0: 48, _9: 57, A: 65, F: 70, a: 97, f: 102 }
function Eu(t) {
  if (t >= sn._0 && t <= sn._9) return t - sn._0
  if (t >= sn.A && t <= sn.F) return t - (sn.A - 10)
  if (t >= sn.a && t <= sn.f) return t - (sn.a - 10)
}
function Ei(t) {
  if (typeof t != 'string') throw new Error('hex string expected, got ' + typeof t)
  if (Vf) return Uint8Array.fromHex(t)
  const e = t.length,
    n = e / 2
  if (e % 2) throw new Error('hex string expected, got unpadded hex of length ' + e)
  const r = new Uint8Array(n)
  for (let o = 0, s = 0; o < n; o++, s += 2) {
    const c = Eu(t.charCodeAt(s)),
      u = Eu(t.charCodeAt(s + 1))
...
function ye(t, e, n) {
  ...
  else if (vr(e)) r = Uint8Array.from(e)
...
function Pe(t, e, n, r) {
  if (!uo(e, n, r)) throw new Error('expected valid ' + t + ': ' + n + ' <= n < ' + r + ', got ' + e)
}
function sh(t) {
  let e
...
const zi = (t) => (ya << BigInt(t)) - ya,
  zs = (t) => new Uint8Array(t),
  xu = (t) => Uint8Array.from(t)
function ah(t, e, n) {
...
const oe = BigInt(0),
  Vt = BigInt(1),
  Yn = /* @__PURE__ */ BigInt(2),
  uh = /* @__PURE__ */ BigInt(3),
  wa = /* @__PURE__ */ BigInt(4),
  Au = /* @__PURE__ */ BigInt(5),
  ku = /* @__PURE__ */ BigInt(8)
function re(t, e) {
  const n = t % e
  return n >= oe ? n : e + n
}
function fh(t, e, n) {
  if (e < oe) throw new Error('invalid exponent, negatives unsupported')
...
function ma(t, e) {
  if (t === oe) throw new Error('invert: expected non-zero number')
...
function lh(t) {
  ...
  if (r === 1) {
    ...
    return function (f, h) {
      const y = f.pow(h, c)
      if (!f.eql(f.sqr(y), h)) throw new Error('Cannot find square root')
      return y
    }
  }
  const s = (n + Vt) / Yn
  return function (u, f) {
    if (u.pow(f, e) === u.neg(u.ONE)) throw new Error('Cannot find square root')
    let h = r,
      y = u.pow(u.mul(u.ONE, o), n),
      g = u.pow(f, s),
      m = u.pow(f, n)
    for (; !u.eql(m, u.ONE); ) {
      if (u.eql(m, u.ZERO)) return u.ZERO
      let b = 1
      for (let T = u.sqr(m); b < h && !u.eql(T, u.ONE); b++) T = u.sqr(T)
  ...
  if (t % ku === Au) {
    ...
    return function (r, o) {
      const s = r.mul(o, Yn),
        c = r.pow(s, e),
        u = r.mul(o, c),
        f = r.mul(r.mul(u, Yn), c),
        h = r.mul(u, r.sub(f, r.ONE))
      if (!r.eql(r.sqr(h), o)) throw new Error('Cannot find square root')
      return h
    }
  }
  return lh(t)
...
function gh(t, e, n) {
  if (n < oe) throw new Error('invalid exponent, negatives unsupported')
...
function vh(t, e) {
  return {
    ...
    unsafeLadder(n, r, o = t.ZERO) {
      let s = n
      for (; r > Tu; ) r & ba && (o = o.add(s)), (s = s.double()), (r >>= ba)
      return o
    },
    /**
    ...
    precomputeWindow(n, r) {
      const { windows: o, windowSize: s } = Ws(r, e),
        c = []
      let u = n,
        f = u
      for (let h = 0; h < o; h++) {
        ;(f = u), c.push(f)
        for (let y = 1; y < s; y++) (f = f.add(u)), c.push(f)
        u = f.double()
      }
      return c
    },
...
function Eh(t, e, n, r) {
  ...
  const o = t.ZERO,
    s = sh(BigInt(n.length)),
    c = s > 12 ? s - 3 : s > 4 ? s - 2 : s ? 2 : 1,
    u = zi(c),
    f = new Array(Number(u) + 1).fill(o),
  ...
  for (let g = h; g >= 0; g -= c) {
    ...
    for (let b = 0; b < r.length; b++) {
      const U = r[b],
        T = Number((U >> BigInt(g)) & u)
      f[T] = f[T].add(n[b])
    }
    let m = o
    for (let b = f.length - 1, U = o; b > 0; b--) (U = U.add(f[b])), (m = m.add(U))
    if (((y = y.add(m)), g !== 0)) for (let b = 0; b < c; b++) y = y.double()
  }
  return y
}
function Qf(t) {
...
const un = {
    ...
    toSig(t) {
      const { Err: e, _int: n, _tlv: r } = un,
        o = ye('signature', t),
        { v: s, l: c } = r.decode(48, o)
...
function Ah(t) {
  const e = xh(t),
    ...
    s =
      e.fromBytes ||
      ((T) => {
        const v = T.subarray(1),
          I = n.fromBytes(v.subarray(0, n.BYTES)),
          O = n.fromBytes(v.subarray(n.BYTES, 2 * n.BYTES))
        return { x: I, y: O }
      })
  function c(T) {
    const { a: v, b: I } = e,
  ...
  function f(T) {
    ...
    if (v && typeof T != 'bigint') {
      if ((vr(T) && (T = ao(T)), typeof T != 'string' || !v.includes(T.length))) throw new Error('invalid private key')
      T = T.padStart(I * 2, '0')
    }
    let j
    try {
  ...
  const y = Su((T, v) => {
      ...
      if (n.eql(M, n.ONE)) return { x: I, y: O }
      const j = T.is0()
      v == null && (v = j ? n.ONE : n.inv(M))
      const G = n.mul(I, v),
        W = n.mul(O, v),
        z = n.mul(M, v)
      if (j) return { x: n.ZERO, y: n.ZERO }
    ...
    g = Su((T) => {
      ...
      const O = n.sqr(I),
        M = c(v)
      if (!n.eql(O, M)) throw new Error('bad point: equation left != right')
  ...
  class m {
    constructor(v, I, O) {
      ...
      if (O == null || !n.isValid(O)) throw new Error('z required')
    ...
    static fromAffine(v) {
      const { x: I, y: O } = v || {}
      if (!v || !n.isValid(I) || !n.isValid(O)) throw new Error('invalid affine point')
    ...
    equals(v) {
      h(v)
      const { px: I, py: O, pz: M } = this,
        { px: j, py: G, pz: W } = v,
        z = n.eql(n.mul(I, W), n.mul(j, M)),
        tt = n.eql(n.mul(O, W), n.mul(G, M))
      return z && tt
    }
    /**
    ...
    multiply(v) {
      ...
      if (I) {
        ...
        let { p: P, f: at } = this.wNAF(W),
          { p: lt, f: ct } = this.wNAF(tt)
        ;(P = U.constTimeNegate(G, P)),
          (lt = U.constTimeNegate(z, lt)),
          (lt = new m(n.mul(lt.px, I.beta), lt.py, lt.pz)),
          (M = P.add(lt)),
          (j = at.add(ct))
      } else {
    ...
    multiplyAndAddUnsafe(v, I, O) {
      const M = m.BASE,
        j = (W, z) => (z === dn || z === ee || !W.equals(M) ? W.multiplyUnsafe(z) : W.multiply(z)),
        G = j(this, I).add(j(v, O))
...
function Th(t) {
  ...
  const {
      ...
      toBytes(H, V, q) {
        ...
        return (
          so('isCompressed', q),
          q ? dt(Uint8Array.from([V.hasEvenY() ? 2 : 3]), ot) : dt(Uint8Array.from([4]), ot, n.toBytes(et.y))
        )
      },
      fromBytes(H) {
        const V = H.length,
        ...
        if (V === o && (q === 2 || q === 3)) {
          const ot = ke(et)
          if (!uo(ot, ee, n.ORDER)) throw new Error('Point is not on curve')
          const dt = y(ot)
          let mt
          try {
            mt = n.sqrt(dt)
          ...
          const ot = n.fromBytes(et.subarray(0, n.BYTES)),
            dt = n.fromBytes(et.subarray(n.BYTES, 2 * n.BYTES))
          return { x: ot, y: dt }
        } else {
          const ot = o,
            dt = s
  ...
  function j(H, V, q = !0) {
    if (M(H)) throw new Error('first arg must be private key')
  ...
  function P(H, V, q = at) {
    if (['recovered', 'canonical'].some((ae) => ae in q)) throw new Error('sign() legacy options not supported')
    ...
    function Ke(ae) {
      ...
      if (!g(it)) return
      const je = u(it),
        le = f.BASE.multiply(it).toAffine(),
        pt = c(le.x)
      if (pt === dn) return
      const ce = c(je * c($t + pt * It))
      if (ce === dn) return
      let _e = (le.x === pt ? 0 : 2) | Number(le.y & ee),
        Mt = ce
      return dt && b(ce) && ((Mt = U(ce)), (_e ^= 1)), new v(pt, Mt, _e)
    }
    return { seed: Xt, k2sig: Ke }
  }
  const at = { lowS: e.lowS, prehash: !1 },
    lt = { lowS: e.lowS, prehash: !1 }
  function ct(H, V, q = at) {
    const { seed: et, k2sig: ot } = P(H, V, q),
      dt = e
  ...
  function xt(H, V, q, et = lt) {
    ...
    if ((Bu(et), 'strict' in et)) throw new Error('options.strict was renamed to lowS')
    if (St !== void 0 && St !== 'compact' && St !== 'der') throw new Error('format must be compact or der')
    const Dt = typeof ot == 'string' || vr(ot),
      It = !Dt && !St && typeof ot == 'object' && ot !== null && typeof ot.r == 'bigint' && typeof ot.s == 'bigint'
    if (!Dt && !It) throw new Error('invalid signature, expected Uint8Array, hex string or Signature instance')
    let kt, Xt
    try {
    ...
    const { r: $t, s: Ke } = kt,
      ...
      je = c(ae * it),
      le = c($t * it),
      pt = (_e = f.BASE.multiplyAndAddUnsafe(Xt, je, le)) == null ? void 0 : _e.toAffine()
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const xo = BigInt('0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f'),
  xi = BigInt('0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141'),
  fo = BigInt(1),
  Si = BigInt(2),
  Nu = (t, e) => (t + e / Si) / e
function Jf(t) {
  const e = xo,
    ...
    G = ($e(j, r, e) * h) % e,
    W = $e(G, Si, e)
  if (!va.eql(va.sqr(W), t)) throw new Error('Cannot find square root')
  return W
}
const va = Gf(xo, void 0, void 0, { sqrt: Jf }),
  Je = Bh(
    {
      a: BigInt(0),
      b: BigInt(7),
      ...
      endo: {
        ...
        splitScalar: (t) => {
          const e = xi,
            ...
            r = -fo * BigInt('0xe4437ed6010e88286f547fa90abfe4c3'),
            o = BigInt('0x114ca50f7a8e2f3f657c1108d9d44cfd8'),
            s = n,
            c = BigInt('0x100000000000000000000000000000000'),
            u = Nu(s * t, e),
            f = Nu(-r * t, e)
          let h = re(t - u * n - f * o, e),
            y = re(-u * r - f * s, e)
          const g = h > c,
            m = y > c
...
const tc = (t) => t.toRawBytes(!0).slice(1),
  Ea = (t) => Qe(t, 32),
  Xs = (t) => re(t, xo),
  lo = (t) => re(t, xi),
  ec = Je.ProjectivePoint,
  _h = (t, e, n) => ec.BASE.multiplyAndAddUnsafe(t, e, n)
function xa(t) {
  let e = Je.utils.normPrivateKeyToScalar(t),
    n = ec.fromPrivateKey(e)
...
function Ch(t, e, n = Xa(32)) {
  const r = ye('message', t),
    { bytes: o, scalar: s } = xa(e),
    c = ye('auxRand', n, 32),
    u = Ea(s ^ yr(Ai('BIP0340/aux', c))),
    f = Ai('BIP0340/nonce', u, o, r),
    h = lo(yr(f))
  if (h === tl) throw new Error('sign failed: k is zero')
  const { bytes: y, scalar: g } = xa(h),
    m = nl(y, o, r),
    b = new Uint8Array(64)
  if ((b.set(y, 0), b.set(Ea(lo(g + m * s)), 32), !rl(b, r, o))) throw new Error('sign: Invalid signature produced')
  return b
}
function rl(t, e, n) {
  ...
  try {
    const c = el(yr(s)),
      u = yr(r.subarray(0, 32))
    if (!uo(u, fo, xo)) return !1
    const f = yr(r.subarray(32, 64))
    if (!uo(f, fo, xi)) return !1
    const h = nl(Ea(u), tc(c), o),
      y = _h(c, f, lo(-h))
...
const tn = {
  ...
  Uh = /* @__PURE__ */ new Uint8Array([7, 4, 13, 1, 10, 6, 15, 3, 12, 0, 9, 5, 2, 14, 11, 8]),
  ol = /* @__PURE__ */ new Uint8Array(new Array(16).fill(0).map((t, e) => e)),
  $h = /* @__PURE__ */ ol.map((t) => (9 * t + 5) % 16)
let nc = [ol],
  rc = [$h]
for (let t = 0; t < 4; t++) for (let e of [nc, rc]) e.push(e[t].map((n) => Uh[n]))
const il = /* @__PURE__ */ [
  ...
  Rh = /* @__PURE__ */ nc.map((t, e) => t.map((n) => il[e][n])),
  Oh = /* @__PURE__ */ rc.map((t, e) => t.map((n) => il[e][n])),
  Lh = /* @__PURE__ */ new Uint32Array([0, 1518500249, 1859775393, 2400959708, 2840853838]),
  Ph = /* @__PURE__ */ new Uint32Array([1352829926, 1548603684, 1836072691, 2053994217, 0])
function Uu(t, e, n, r) {
  return t === 0
    ? e ^ n ^ r
    : t === 1
...
class Kh extends Df {
  ...
  process(e, n) {
    for (let b = 0; b < 16; b++, n += 4) ii[b] = e.getUint32(n, !0)
    let r = this.h0 | 0,
      o = r,
      s = this.h1 | 0,
      c = s,
...
function ic(t, e) {
  if (!sl(!1, e)) throw new Error(`${t}: array of numbers expected`)
}
// @__NO_SIDE_EFFECTS__
function Wi(...t) {
  const e = (s) => s,
    n = (s, c) => (u) => s(c(u)),
    r = t.map((s) => s.encode).reduceRight(n, e),
    o = t.map((s) => s.decode).reduce(n, e)
  ...
  return {
    ...
    decode: (o) => (
      ...
      o.map((s) => {
        ...
        const c = r.get(s)
        if (c === void 0) throw new Error(`Unknown letter: "${s}". Allowed: ${t}`)
        return c
      })
    ),
  }
...
function $u(t, e, n) {
  ...
  if ((ki(t), !t.length)) return []
  let r = 0
  const o = [],
    s = Array.from(t, (u) => {
      if ((So(u), u < 0 || u >= e)) throw new Error(`invalid integer: ${u}`)
      return u
    }),
    c = s.length
  for (;;) {
    ...
    for (let h = r; h < c; h++) {
      ...
      if (((s[h] = U), !Number.isSafeInteger(U) || U * n + u !== m)) throw new Error('convertRadix: carry overflow')
      if (f) U ? (f = !1) : (r = h)
      else continue
    }
    if ((o.push(u), f)) break
...
const cl = (t, e) => (e === 0 ? t : cl(e, t % e)),
  Ti = /* @__NO_SIDE_EFFECTS__ */ (t, e) => t + (e - cl(t, e)),
  pi = /* @__PURE__ */ (() => {
    let t = []
...
function Sa(t, e, n, r) {
  if ((ki(t), e <= 0 || e > 32)) throw new Error(`convertRadix2: wrong from=${e}`)
  ...
  const c = pi[e],
    ...
    f = []
  for (const h of t) {
    if ((So(h), h >= c)) throw new Error(`convertRadix2: invalid data word=${h} from=${e}`)
    if (((o = (o << e) | h), s + e > 32)) throw new Error(`convertRadix2: carry overflow pos=${s} from=${e}`)
    for (s += e; s >= n; s -= n) f.push(((o >> (s - n)) & u) >>> 0)
    const y = pi[s]
...
function Fh(t) {
  ...
  return {
    encode: (n) => {
      if (!Er(n)) throw new Error('radix.encode input should be Uint8Array')
...
// @__NO_SIDE_EFFECTS__
function ul(t, e = !1) {
  if ((So(t), t <= 0 || t > 32)) throw new Error('radix2: bits should be in (0..32]')
  if (/* @__PURE__ */ Ti(8, t) > 32 || /* @__PURE__ */ Ti(t, 8) > 32) throw new Error('radix2: carry overflow')
  return {
    encode: (n) => {
      if (!Er(n)) throw new Error('radix2.encode input should be Uint8Array')
...
function Vh(t, e) {
  return (
    ...
    {
      encode(n) {
        if (!Er(n)) throw new Error('checksum.encode: input should be Uint8Array')
        const r = e(n).slice(0, t),
          o = new Uint8Array(n.length + t)
        return o.set(n), o.set(r, n.length), o
      },
      decode(n) {
        if (!Er(n)) throw new Error('checksum.decode: input should be Uint8Array')
        const r = n.slice(0, -t),
          o = n.slice(-t),
          s = e(r).slice(0, t)
...
const qh = /* @__NO_SIDE_EFFECTS__ */ (t) =>
    /* @__PURE__ */ Wi(/* @__PURE__ */ Fh(58), /* @__PURE__ */ sc(t), /* @__PURE__ */ ac('')),
  jh = /* @__PURE__ */ qh('123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz'),
  zh = (t) =>
    /* @__PURE__ */ Wi(
      Vh(4, (e) => t(t(e))),
      jh,
    ),
  Aa = /* @__PURE__ */ Wi(/* @__PURE__ */ sc('qpzry9x8gf2tvdw0s3jn54khce6mua7l'), /* @__PURE__ */ ac('')),
  Ou = [996825010, 642813549, 513874426, 1027748829, 705979059]
function Gr(t) {
  const e = t >> 25
  let n = (t & 33554431) << 5
  for (let r = 0; r < Ou.length; r++) ((e >> r) & 1) === 1 && (n ^= Ou[r])
  return n
}
function Lu(t, e, n = 1) {
  const r = t.length
  ...
  o = Gr(o)
  for (let s = 0; s < r; s++) o = Gr(o) ^ (t.charCodeAt(s) & 31)
  for (let s of e) o = Gr(o) ^ s
  for (let s = 0; s < 6; s++) o = Gr(o)
...
function fl(t) {
  ...
  function c(g, m, b = 90) {
    ...
    const U = g.length
    if (U === 0) throw new TypeError(`Invalid prefix length ${U}`)
    const T = U + 7 + m.length
    if (b !== !1 && T > b) throw new TypeError(`Length ${T} exceeds limit ${b}`)
  ...
  function u(g, m = 90) {
    ...
    const b = g.length
    if (b < 8 || (m !== !1 && b > m)) throw new TypeError(`invalid string length: ${b} (${g}). Expected (8..${m})`)
    const U = g.toLowerCase()
    if (g !== U && g !== g.toUpperCase()) throw new Error('String must be lowercase or uppercase')
    ...
    const O = Aa.decode(I).slice(0, -6),
      M = Lu(v, O, e)
    if (!I.endsWith(M)) throw new Error(`Invalid checksum in ${g}: expected "${M}"`)
...
const ka = /* @__PURE__ */ fl('bech32'),
  ll = /* @__PURE__ */ fl('bech32m'),
  Gh = {
    encode: (t) => new TextDecoder().decode(t),
    decode: (t) => new TextEncoder().encode(t),
  },
  Wh = typeof Uint8Array.from([]).toHex == 'function' && typeof Uint8Array.fromHex == 'function',
  Yh = {
    encode(t) {
      return Mh(t), t.toHex()
    },
  ...
  Pt = /* @__PURE__ */ new Uint8Array(),
  dl = /* @__PURE__ */ new Uint8Array([0])
function Sr(t, e) {
  if (t.length !== e.length) return !1
...
function Zh(...t) {
  ...
  for (let r = 0; r < t.length; r++) {
    const o = t[r]
    if (!Le(o)) throw new Error('Uint8Array expected')
    e += o.length
  }
  const n = new Uint8Array(e)
  for (let r = 0, o = 0; r < t.length; r++) {
...
class uc {
  ...
  find(e, n = this.pos) {
    if (!Le(e)) throw this.err(`find: needle is not bytes! ${e}`)
    ...
    for (let r = n; (r = this.data.indexOf(e[0], r)) !== -1; r++) {
      ...
      if (Sr(e, this.data.subarray(r, r + e.length))) return r
    }
  }
}
class Xh {
...
function Jh() {
  return {
    ...
    decode: (t) => {
      if (!Ao(t)) throw new Error(`expected plain object, got ${t}`)
...
function ep(t) {
  if (!Ao(t)) throw new Error('plain object expected')
  return {
    encode: (e) => {
...
function np(t, e = !1) {
  if (!en(t)) throw new Error(`decimal/precision: wrong value ${t}`)
...
function rp(t) {
  ...
  for (const e of t) if (!Yi(e)) throw new Error(`wrong base coder ${e}`)
  return {
    encode: (e) => {
      for (const n of t) {
        const r = n.encode(e)
...
const yl = (t) => {
    if (!Yi(t)) throw new Error('BaseCoder expected')
    return { encode: t.decode, decode: t.encode }
  },
  Zi = { dict: Jh, numberBigint: tp, tsEnum: ep, decimal: np, match: rp, reverse: yl },
  fc = (t, e = !1, n = !1, r = !0) => {
    if (!en(t)) throw new Error(`bigint/size: wrong value ${t}`)
    ...
    return Be({
      ...
      decodeStream: (c) => {
        const u = c.bytes(r ? t : Math.min(t, c.leftBytes)),
          f = e ? u : Ta(u)
        let h = 0n
        for (let y = 0; y < f.length; y++) h |= BigInt(f[y]) << (8n * BigInt(y))
        return n && h & s && (h = (h ^ s) - s), h
      },
      validate: (c) => {
        if (typeof c != 'bigint') throw new Error(`bigint: invalid value: ${c}`)
  ...
  ko = (t, e, n) => {
    const r = t * 8,
      o = 2 ** (r - 1),
      s = (f) => {
        if (!en(f)) throw new Error(`sintView: value is not safe integer: ${f}`)
  ...
  Lt = (t, e = !1) => {
    ...
    return Be({
      ...
      decodeStream: (o) => {
        ...
        } else s = o.bytes(t === null ? o.leftBytes : n.decodeStream(o))
        return e ? Ta(s) : s
      },
      validate: (o) => {
        if (!Le(o)) throw new Error(`bytes: invalid value ${o}`)
        return o
      },
    })
  }
function ap(t, e) {
  if (!Fe(e)) throw new Error(`prefix: invalid inner value ${e}`)
  return $n(Lt(t), yl(e))
}
const lc = (t, e = !1) =>
    Ie($n(Lt(t, e), Gh), (n) => {
    ...
    return (
      r &&
        (n = $n(n, {
          encode: (o) => `0x${o}`,
          decode: (o) => {
            if (!o.startsWith('0x')) throw new Error('hex(with0x=true).encode input should start with 0x')
            return o.slice(2)
          },
        })),
      n
...
function $n(t, e) {
  if (!Fe(t)) throw new Error(`apply: invalid inner value ${t}`)
  if (!Yi(e)) throw new Error(`apply: invalid base value ${t}`)
  return Be({
    size: t.size,
    encodeStream: (n, r) => {
      let o
...
const up = (t, e = !1) => {
  if (!Le(t)) throw new Error(`flag/flagValue: expected Uint8Array, got ${typeof t}`)
...
function fp(t, e, n) {
  if (!Fe(e)) throw new Error(`flagged: invalid inner value ${e}`)
  return Be({
    encodeStream: (r, o) => {
...
function dc(t, e, n = !0) {
  if (!Fe(t)) throw new Error(`magic: invalid inner value ${t}`)
...
function se(t) {
  if (!Ao(t)) throw new Error(`struct: expected plain object, got ${t}`)
...
function El(t, e) {
  ...
  if (o >= Ii) throw new Error('tweak higher than curve order')
  return o
}
function pp(t, e = new Uint8Array()) {
  const n = tn.utils,
    r = n.bytesToNumberBE(t),
    o = Xi.fromPrivateKey(r),
    s = o.hasEvenY() ? r : n.mod(-r, Ii),
    c = n.pointToBytes(o),
    u = El(c, e)
...
function xl(t, e) {
  const n = tn.utils,
    r = El(t, e),
    s = n.lift_x(n.bytesToNumberBE(t)).add(Xi.fromPrivateKey(r)),
    c = s.hasEvenY() ? 0 : 1
  return [n.pointToBytes(s), c]
}
const gc = Se(Xi.BASE.toRawBytes(!1)),
  kr = {
    bech32: 'bc',
    pubKeyHash: 0,
    scriptHash: 5,
...
function Bi(t, e) {
  if (!Ut(t) || !Ut(e)) throw new Error(`cmp: wrong type a=${typeof t} b=${typeof e}`)
...
function gp(t, e = '=') {
  return (
    ...
    {
      encode(n) {
        for (Ni('padding.encode', n); (n.length * t) % 8; ) n.push(e)
        return n
      },
      decode(n) {
        Ni('padding.decode', n)
...
function Mu(t, e, n) {
  if (e < 2) throw new Error(`convertRadix: invalid from=${e}, base cannot be less than 2`)
  if (n < 2) throw new Error(`convertRadix: invalid to=${n}, base cannot be less than 2`)
  if ((_i(t), !t.length)) return []
  let r = 0
  const o = [],
    s = Array.from(t, (u) => {
      if ((To(u), u < 0 || u >= e)) throw new Error(`invalid integer: ${u}`)
      return u
    }),
    c = s.length
  for (;;) {
...
const kl = (t, e) => (e === 0 ? t : kl(e, t % e)),
  Ci = /* @__NO_SIDE_EFFECTS__ */ (t, e) => t + (e - kl(t, e)),
  yi = /* @__PURE__ */ (() => {
    let t = []
    for (let e = 0; e < 40; e++) t.push(2 ** e)
    return t
...
function Ia(t, e, n, r) {
  if ((_i(t), e <= 0 || e > 32)) throw new Error(`convertRadix2: wrong from=${e}`)
  if (n <= 0 || n > 32) throw new Error(`convertRadix2: wrong to=${n}`)
  ...
  const c = yi[e],
    ...
    f = []
  for (const h of t) {
    if ((To(h), h >= c)) throw new Error(`convertRadix2: invalid data word=${h} from=${e}`)
    if (((o = (o << e) | h), s + e > 32)) throw new Error(`convertRadix2: carry overflow pos=${s} from=${e}`)
    for (s += e; s >= n; s -= n) f.push(((o >> (s - n)) & u) >>> 0)
    const y = yi[s]
    if (y === void 0) throw new Error('invalid carry')
...
// @__NO_SIDE_EFFECTS__
function mc(t, e = !1) {
  if ((To(t), t <= 0 || t > 32)) throw new Error('radix2: bits should be in (0..32]')
  if (/* @__PURE__ */ Ci(8, t) > 32 || /* @__PURE__ */ Ci(t, 8) > 32) throw new Error('radix2: carry overflow')
  return {
    encode: (n) => {
...
const ve = /* @__PURE__ */ Qi(
    /* @__PURE__ */ mc(6),
    /* @__PURE__ */ Ji('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'),
    /* @__PURE__ */ gp(6),
    /* @__PURE__ */ ts(''),
  ),
  mp = /* @__NO_SIDE_EFFECTS__ */ (t) =>
    /* @__PURE__ */ Qi(/* @__PURE__ */ wp(58), /* @__PURE__ */ Ji(t), /* @__PURE__ */ ts('')),
  Fu = /* @__PURE__ */ mp('123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz'),
  Ba = /* @__PURE__ */ Qi(/* @__PURE__ */ Ji('qpzry9x8gf2tvdw0s3jn54khce6mua7l'), /* @__PURE__ */ ts('')),
  Vu = [996825010, 642813549, 513874426, 1027748829, 705979059]
function Wr(t) {
  const e = t >> 25
  let n = (t & 33554431) << 5
  for (let r = 0; r < Vu.length; r++) ((e >> r) & 1) === 1 && (n ^= Vu[r])
  return n
}
function qu(t, e, n = 1) {
  const r = t.length
  ...
  o = Wr(o)
  for (let s = 0; s < r; s++) o = Wr(o) ^ (t.charCodeAt(s) & 31)
  for (let s of e) o = Wr(o) ^ s
  for (let s = 0; s < 6; s++) o = Wr(o)
...
const ai = /* @__PURE__ */ bp('bech32m'),
  ht = /* @__PURE__ */ Qi(
    /* @__PURE__ */ mc(4),
    /* @__PURE__ */ Ji('0123456789abcdef'),
    /* @__PURE__ */ ts(''),
    /* @__PURE__ */ yp((t) => {
      if (typeof t != 'string' || t.length % 2 !== 0)
        throw new TypeError(`hex.decode: expected string, got ${typeof t} with length ${t.length}`)
...
const { taggedHash: Il, pointToBytes: ci } = tn.utils,
  Rn = Je.ProjectivePoint,
  nn = 33,
  _a = new Uint8Array(nn),
  _n = Je.CURVE.n,
  ju = $n(Lt(33), {
    decode: (t) => (bc(t) ? _a : t.toRawBytes(!0)),
    encode: (t) => (co(t, _a) ? Rn.ZERO : Rn.fromHex(t)),
  }),
  zu = Ie(wl, (t) => (Pe('n', t, 1n, _n), t)),
  wi = se({ R1: ju, R2: ju }),
  Bl = se({ k1: zu, k2: zu, publicKey: Lt(nn) })
function Gu(t, ...e) {}
function De(t, ...e) {
...
function _l(t) {
  De(t, nn)
  for (let e = 1; e < t.length; e++) if (!co(t[e], t[0])) return t[e]
  return _a
}
function Nl(t) {
...
function Ca(t, e = [], n = []) {
  ...
  for (let f = 0; f < e.length; f++) {
    const h = n[f] && !s.hasEvenY() ? Me(-1n) : 1n,
      y = ke(e[f])
...
class Ep {
  ...
  constructor(e, n, r, o = [], s = []) {
    if ((De(n, 33), De(o, 32), Wu(s), Ae(r), o.length !== s.length))
      throw new Error('The tweaks and isXonly arrays must have the same length')
    const { aggPublicKey: c, gAcc: u, tweakAcc: f } = Ca(n, o, s),
      { R1: h, R2: y } = wi.decode(e)
    ;(this.publicKeys = n),
      (this.Q = c),
      (this.gAcc = u),
      (this.tweakAcc = f),
      (this.b = Ui('MuSig/noncecoef', e, ci(c), r))
    const g = h.add(y.multiply(this.b))
    ;(this.R = bc(g) ? Rn.BASE : g),
      (this.e = Ui('BIP0340/challenge', ci(this.R), ci(c), r)),
      (this.tweaks = o),
      (this.isXonly = s),
      (this.L = Nl(n)),
      (this.secondKey = _l(n))
  ...
  getSessionKeyAggCoeff(e) {
    const { publicKeys: n } = this,
      r = e.toRawBytes(!0)
    if (!n.some((s) => co(s, r))) throw new Error("The signer's pubkey must be included in the list of pubkeys")
  ...
  partialSigVerifyInternal(e, n, r) {
    const { Q: o, gAcc: s, b: c, R: u, e: f } = this,
      h = ke(e)
    if (h >= _n) return !1
    const { R1: y, R2: g } = wi.decode(n),
      m = y.add(g.multiply(c)),
      b = u.hasEvenY() ? m : m.negate(),
      U = Rn.fromHex(r),
      T = this.getSessionKeyAggCoeff(U),
      v = Me(Yr(o, 1n) * s),
      I = Qn(h),
      O = b.add(U.multiply(Me(f * T * v)))
    return I.equals(O)
  }
  /**
  ...
  sign(e, n, r = !1) {
    ...
    const { Q: o, gAcc: s, b: c, R: u, e: f } = this,
      { k1: h, k2: y, publicKey: g } = Bl.decode(e)
    ...
    const T = Qn(U),
      v = T.toRawBytes(!0)
    if (!co(v, g)) throw new Error('Public key does not match nonceGen argument')
    const I = this.getSessionKeyAggCoeff(T),
      O = Yr(o, 1n),
      M = Me(O * s * U),
      j = Me(m + c * b + f * I * M),
      G = Qe(j, 32)
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const es = /* @__PURE__ */ BigInt(0),
  ns = /* @__PURE__ */ BigInt(1),
  Sp = /* @__PURE__ */ BigInt(2)
function er(t) {
  return t instanceof Uint8Array || (ArrayBuffer.isView(t) && t.constructor.name === 'Uint8Array')
}
function Io(t) {
...
function Br(t) {
  Io(t)
  let e = ''
  for (let n = 0; n < t.length; n++) e += Ap[t[n]]
  return e
}
function pr(t) {
  const e = t.toString(16)
...
function Zu(t) {
  if (t >= an._0 && t <= an._9) return t - an._0
  if (t >= an.A && t <= an.F) return t - (an.A - 10)
  if (t >= an.a && t <= an.f) return t - (an.a - 10)
}
function _r(t) {
  if (typeof t != 'string') throw new Error('hex string expected, got ' + typeof t)
  ...
  const r = new Uint8Array(n)
  for (let o = 0, s = 0; o < n; o++, s += 2) {
    const c = Zu(t.charCodeAt(s)),
      u = Zu(t.charCodeAt(s + 1))
    if (c === void 0 || u === void 0) {
      const f = t[s] + t[s + 1]
      throw new Error('hex string expected, got non-hex character "' + f + '" at index ' + s)
    }
...
function we(t, e, n) {
  ...
  else if (er(e)) r = Uint8Array.from(e)
  else throw new Error(t + ' must be hex string or Uint8Array')
  const o = r.length
  if (typeof n == 'number' && o !== n) throw new Error(t + ' of length ' + n + ' expected, got ' + o)
  return r
...
function Un(t, e, n, r) {
  if (!Nr(e, n, r)) throw new Error('expected valid ' + t + ': ' + n + ' <= n < ' + r + ', got ' + e)
}
function Ul(t) {
  let e
...
const Sc = (t) => (Sp << BigInt(t - 1)) - ns,
  Js = (t) => new Uint8Array(t),
  Xu = (t) => Uint8Array.from(t)
function $l(t, e, n) {
  if (typeof t != 'number' || t < 2) throw new Error('hashLen must be a number')
  if (typeof e != 'number' || e < 2) throw new Error('qByteLen must be a number')
...
const Up = /* @__PURE__ */ Object.freeze(
...
const Ac = 2n ** 256n,
  wr = Ac - 0x1000003d1n,
  Rl = Ac - 0x14551231950b75fc4402da1732fc9bebfn,
  $p = 0x79be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798n,
  Rp = 0x483ada7726a3c4655da4fbfc0e1108a8fd17b448a68554199c47d08ffb10d4b8n,
  kc = {
    n: Rl,
    a: 0n,
    b: 7n,
  ...
  eo = 32,
  Qu = (t) => ft(ft(t * t) * t + kc.b),
  me = (t = '') => {
    throw new Error(t)
  },
  rs = (t) => typeof t == 'bigint',
  Ol = (t) => typeof t == 'string',
  ta = (t) => rs(t) && 0n < t && t < wr,
  Ll = (t) => rs(t) && 0n < t && t < Rl,
  Op = (t) => t instanceof Uint8Array || (ArrayBuffer.isView(t) && t.constructor.name === 'Uint8Array'),
  $a = (t, e) =>
    // assert is Uint8Array (of specific length)
    !Op(t) || (typeof e == 'number' && e > 0 && t.length !== e) ? me('Uint8Array expected') : t,
  Pl = (t) => new Uint8Array(t),
  Kl = (t, e) => $a(Ol(t) ? Tc(t) : Pl($a(t)), e),
  ft = (t, e = wr) => {
    const n = t % e
    return n >= 0n ? n : e + n
  },
...
let Cr = class dr {
  ...
  mul(e, n = !0) {
    if (!n && e === 0n) return Jr
    if ((Ll(e) || me('scalar invalid'), this.equals(no))) return Hp(e).p
    let r = Jr,
      o = no
    for (let s = this; e > 0n; s = s.double(), e >>= 1n) e & 1n ? (r = r.add(s)) : n && (o = o.add(s))
    return r
  }
  mulAddQUns(e, n, r) {
  ...
  toAffine() {
    ...
    if (this.equals(Jr)) return { x: 0n, y: 0n }
  ...
  assertValidity() {
    ...
    return (
      (!ta(e) || !ta(n)) && me('Point invalid: x or y'),
      ft(n * n) === Qu(e)
...
const { BASE: no, ZERO: Jr } = Cr,
  Dl = (t, e) => t.toString(16).padStart(e, '0'),
  Ml = (t) =>
    Array.from($a(t))
      .map((e) => Dl(e, 2))
      .join(''),
  ...
  tf = (t) => {
    if (t >= cn._0 && t <= cn._9) return t - cn._0
  ...
  Tc = (t) => {
    ...
    for (let s = 0, c = 0; s < r; s++, c += 2) {
      const u = tf(t.charCodeAt(c)),
        f = tf(t.charCodeAt(c + 1))
      if (u === void 0 || f === void 0) return me(e)
      o[s] = u * 16 + f
    }
    return o
  },
  Hl = (t) => BigInt('0x' + (Ml(t) || '0')),
  ef = (t, e, n) => Hl(t.slice(e, n)),
  Lp = (t) => (rs(t) && t >= 0n && t < Ac ? Tc(Dl(t, 2 * eo)) : me('bigint expected')),
  nf = (t) => Ml(Lp(t)),
  Pp = (t, e) => {
  ...
  Kp = (t) => {
    let e = 1n
    for (let n = t, r = (wr + 1n) / 4n; r > 0n; r >>= 1n) r & 1n && (e = (e * n) % wr), (n = (n * n) % wr)
    return ft(e * e) === t ? e : me('sqrt invalid')
  },
  Dp = (t) => (rs(t) || (t = Hl(Kl(t, eo))), Ll(t) ? t : me('private key invalid 3')),
  Zn = 8,
  Mp = () => {
    const t = [],
      e = 256 / Zn + 1
    ...
    for (let o = 0; o < e; o++) {
      ;(r = n), t.push(r)
      for (let s = 1; s < 2 ** (Zn - 1); s++) (r = r.add(n)), t.push(r)
      n = r.double()
    }
    return t
  }
...
function os(t, ...e) {
  if (!Fp(t)) throw new Error('Uint8Array expected')
  if (e.length > 0 && !e.includes(t.length))
    throw new Error('Uint8Array expected of length ' + e + ', got length=' + t.length)
}
function Vp(t) {
...
function Gp(t) {
  const e = (r) => t().update(Ic(r)).digest(),
    n = t()
  return (e.outputLen = n.outputLen), (e.blockLen = n.blockLen), (e.create = () => t()), e
}
function Vl(t = 32) {
  if (lr && typeof lr.getRandomValues == 'function') return lr.getRandomValues(new Uint8Array(t))
  if (lr && typeof lr.randomBytes == 'function') return lr.randomBytes(t)
  throw new Error('crypto.getRandomValues must be defined')
}
function Wp(t, e, n, r) {
  if (typeof t.setBigUint64 == 'function') return t.setBigUint64(e, n, r)
...
const Yp = (t, e, n) => (t & e) ^ (~t & n),
  Zp = (t, e, n) => (t & e) ^ (t & n) ^ (e & n)
class Xp extends Fl {
  constructor(e, n, r, o) {
    super(),
      (this.blockLen = e),
...
class Jp extends Xp {
  ...
  process(e, n) {
    for (let g = 0; g < 16; g++, n += 4) In[g] = e.getUint32(n, !1)
    for (let g = 16; g < 64; g++) {
      const m = In[g - 15],
        b = In[g - 2],
        U = Ze(m, 7) ^ Ze(m, 18) ^ (m >>> 3),
        T = Ze(b, 17) ^ Ze(b, 19) ^ (b >>> 10)
      In[g] = (T + In[g - 7] + U + In[g - 16]) | 0
    }
    let { A: r, B: o, C: s, D: c, E: u, F: f, G: h, H: y } = this
    for (let g = 0; g < 64; g++) {
      const m = Ze(u, 6) ^ Ze(u, 11) ^ Ze(u, 25),
        b = (y + m + Yp(u, f, h) + Qp[g] + In[g]) | 0,
        T = ((Ze(r, 2) ^ Ze(r, 13) ^ Ze(r, 22)) + Zp(r, o, s)) | 0
      ;(y = h), (h = f), (f = u), (u = (c + b) | 0), (c = s), (s = o), (o = r), (r = (b + T) | 0)
    }
    ;(r = (r + this.A) | 0),
      (o = (o + this.B) | 0),
...
const ie = BigInt(0),
  qt = BigInt(1),
  Xn = /* @__PURE__ */ BigInt(2),
  tg = /* @__PURE__ */ BigInt(3),
  Oa = /* @__PURE__ */ BigInt(4),
  sf = /* @__PURE__ */ BigInt(5),
  af = /* @__PURE__ */ BigInt(8)
function ue(t, e) {
  const n = t % e
  return n >= ie ? n : e + n
}
...
function sg(t, e, n) {
  if (n < ie) throw new Error('invalid exponent, negatives unsupported')
...
function lg(t, e) {
  return {
    ...
    unsafeLadder(n, r, o = t.ZERO) {
      let s = n
      for (; r > cf; ) r & ui && (o = o.add(s)), (s = s.double()), (r >>= ui)
      return o
    },
    /**
     * Creates a wNAF precomputation window. Used for caching.
     ...
     */
    precomputeWindow(n, r) {
      const { windows: o, windowSize: s } = ra(r, e),
        c = []
      let u = n,
        f = u
      for (let h = 0; h < o; h++) {
     ...
     */
    wNAFUnsafe(n, r, o, s = t.ZERO) {
      const { windows: c, windowSize: u } = ra(n, e),
        f = BigInt(2 ** n - 1),
        h = 2 ** n,
        y = BigInt(n)
      for (let g = 0; g < c; g++) {
        ...
        if (o === cf) break
        let b = Number(o & f)
        if (((o >>= y), b > u && ((b -= h), (o += ui)), b === 0)) continue
...
function dg(t, e, n, r) {
  if ((ug(n, t), fg(r, e), n.length !== r.length))
    throw new Error('arrays of points and scalars must have equal length')
  const o = t.ZERO,
    s = Ul(BigInt(n.length)),
    c = s > 12 ? s - 3 : s > 4 ? s - 2 : s ? 2 : 1,
    u = (1 << c) - 1,
    f = new Array(u + 1).fill(o),
    h = Math.floor((e.BITS - 1) / c) * c
  let y = o
  for (let g = h; g >= 0; g -= c) {
    f.fill(o)
...
const { bytesToNumberBE: pg, hexToBytes: gg } = Up,
  fn = {
    // asn.1 DER encoding utils
    ...
    toSig(t) {
      const { Err: e, _int: n, _tlv: r } = fn,
        o = typeof t == 'string' ? gg(t) : t
      Io(o)
...
function yg(t) {
  ...
  function f(T) {
    const { allowedPrivateKeyLengths: v, nByteLength: I, wrapPrivateKey: O, n: M } = e
    if (v && typeof T != 'bigint') {
      if ((er(T) && (T = Br(T)), typeof T != 'string' || !v.includes(T.length))) throw new Error('invalid private key')
      T = T.padStart(I * 2, '0')
    }
    let j
    try {
  ...
  class m {
    constructor(v, I, O) {
      if (((this.px = v), (this.py = I), (this.pz = O), v == null || !n.isValid(v))) throw new Error('x required')
      if (I == null || !n.isValid(I)) throw new Error('y required')
      if (O == null || !n.isValid(O)) throw new Error('z required')
      Object.freeze(this)
    }
    ...
    multiplyAndAddUnsafe(v, I, O) {
      const M = m.BASE,
        j = (W, z) => (z === hn || z === ne || !W.equals(M) ? W.multiplyUnsafe(z) : W.multiply(z)),
        G = j(this, I).add(j(v, O))
      return G.is0() ? void 0 : G
    }
    // Converts Projective point to affine (x, y) coordinates.
...
function mg(t) {
  ...
  const {
      ...
      fromBytes(H) {
        ...
        if (V === o && (q === 2 || q === 3)) {
          const ot = Xe(et)
          if (!Nr(ot, ne, n.ORDER)) throw new Error('Point is not on curve')
          const dt = y(ot)
          let mt
          try {
            mt = n.sqrt(dt)
  ...
  function P(H, V, q = at) {
    ...
    function Ke(ae) {
      ...
      const ce = c(je * c($t + pt * It))
      if (ce === hn) return
      let _e = (le.x === pt ? 0 : 2) | Number(le.y & ne),
        Mt = ce
      return dt && b(ce) && ((Mt = U(ce)), (_e ^= 1)), new v(pt, Mt, _e)
    }
    return { seed: Xt, k2sig: Ke }
  ...
  function xt(H, V, q, et = lt) {
    ...
    const { lowS: dt, prehash: mt, format: St } = et
    if ((uf(et), 'strict' in et)) throw new Error('options.strict was renamed to lowS')
    if (St !== void 0 && St !== 'compact' && St !== 'der') throw new Error('format must be compact or der')
    const Dt = typeof ot == 'string' || er(ot),
      It = !Dt && !St && typeof ot == 'object' && ot !== null && typeof ot.r == 'bigint' && typeof ot.s == 'bigint'
    if (!Dt && !It) throw new Error('invalid signature, expected Uint8Array, hex string or Signature instance')
    let kt, Xt
    try {
...
const _o = BigInt('0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f'),
  Ri = BigInt('0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141'),
  ho = BigInt(1),
  Oi = BigInt(2),
  lf = (t, e) => (t + e / Oi) / e
function Jl(t) {
  const e = _o,
    ...
    G = (Re(j, r, e) * h) % e,
    W = Re(G, Oi, e)
  if (!Pa.eql(Pa.sqr(W), t)) throw new Error('Cannot find square root')
  return W
}
const Pa = Gl(_o, void 0, void 0, { sqrt: Jl }),
  po = vg(
    {
      a: BigInt(0),
      // equation params: a, b
      ...
      endo: {
        ...
        splitScalar: (t) => {
          const e = Ri,
            n = BigInt('0x3086d221a7d46bcde86c90e49284eb15'),
            r = -ho * BigInt('0xe4437ed6010e88286f547fa90abfe4c3'),
            o = BigInt('0x114ca50f7a8e2f3f657c1108d9d44cfd8'),
            s = n,
            c = BigInt('0x100000000000000000000000000000000'),
            u = lf(s * t, e),
            f = lf(-r * t, e)
          let h = ue(t - u * n - f * o, e),
            y = ue(-u * r - f * s, e)
          const g = h > c,
            m = y > c
          if ((g && (h = e - h), m && (y = e - y), h > c || y > c))
...
const Bc = (t) => t.toRawBytes(!0).slice(1),
  Ka = (t) => On(t, 32),
  sa = (t) => ue(t, _o),
  go = (t) => ue(t, Ri),
  _c = po.ProjectivePoint,
  Eg = (t, e, n) => _c.BASE.multiplyAndAddUnsafe(t, e, n)
function Da(t) {
  let e = po.utils.normPrivateKeyToScalar(t),
    n = _c.fromPrivateKey(e)
...
function Sg(t, e, n = Vl(32)) {
  const r = we('message', t),
    { bytes: o, scalar: s } = Da(e),
    c = we('auxRand', n, 32),
    u = Ka(s ^ mr(Li('BIP0340/aux', c))),
    f = Li('BIP0340/nonce', u, o, r),
    h = go(mr(f))
  if (h === td) throw new Error('sign failed: k is zero')
  const { bytes: y, scalar: g } = Da(h),
    m = nd(y, o, r),
    b = new Uint8Array(64)
  if ((b.set(y, 0), b.set(Ka(go(g + m * s)), 32), !rd(b, r, o))) throw new Error('sign: Invalid signature produced')
  return b
}
function rd(t, e, n) {
  ...
  try {
    const c = ed(mr(s)),
      u = mr(r.subarray(0, 32))
    if (!Nr(u, ho, _o)) return !1
    const f = mr(r.subarray(32, 64))
    if (!Nr(f, ho, Ri)) return !1
    const h = nd(Ka(u), Bc(c), o),
      y = Eg(c, f, go(-h))
    return !(!y || !y.hasEvenY() || y.toAffine().x !== u)
  } catch {
    return !1
...
function Nc(t, e, n = {}) {
  ...
  const o = od.utils.taggedHash('TapTweak', r.toRawBytes(!0).subarray(1), n.taprootTweak ?? new Uint8Array(0)),
    { aggPublicKey: s } = Ca(t, [o], [!0])
  return {
    preTweakedKey: r.toRawBytes(!0),
...
class Cc {
  constructor(e, n) {
    if (((this.s = e), (this.R = n), e.length !== 32)) throw new fi('Invalid s length')
    if (n.length !== 33) throw new fi('Invalid R length')
  }
  /**
   ...
   */
  static decode(e) {
    if (e.length !== 32) throw new fi('Invalid partial signature length')
    if (Xe(e) >= kc.n) throw new fi('s value overflows curve order')
...
const bt = Be({
    encodeStream: (t, e) => {
      for (let n of e) {
        ...
        r < zt.PUSHDATA1
          ? t.byte(r)
          : r <= 255
          ? (t.byte(zt.PUSHDATA1), t.byte(r))
          : r <= 65535
          ? (t.byte(zt.PUSHDATA2), t.bytes(Pu.encode(r)))
          : (t.byte(zt.PUSHDATA4), t.bytes(Bt.encode(r))),
          t.bytes(n)
      }
    },
    decodeStream: (t) => {
      ...
      for (; !t.isEnd(); ) {
        ...
        if (zt.OP_0 < n && n <= zt.PUSHDATA4) {
          ...
          else if (n === zt.PUSHDATA1) r = Cn.decodeStream(t)
          else if (n === zt.PUSHDATA2) r = Pu.decodeStream(t)
          else if (n === zt.PUSHDATA4) r = Bt.decodeStream(t)
  ...
  is = Be({
    ...
    decodeStream: (t) => {
      ...
      const [n, r, o] = gf[e]
      let s = 0n
      for (let c = 0; c < r; c++) s |= BigInt(t.byte()) << (8n * BigInt(c))
      if (s < o) throw t.err(`Wrong CompactSize(${8 * r})`)
      return s
    },
  }),
  Ve = $n(is, Zi.numberBigint),
  He = Lt(is),
  Uc = Te(Ve, He),
  Pi = (t) => Te(is, t),
  id = se({
...
function yf(t, e, n, r = !1, o = !1) {
  ...
  typeof s == 'string' && (s = _t.decode(s)),
    Ut(s) && (s = br.decode(s)),
    !('nonWitnessUtxo' in t) && s === void 0 && (s = e == null ? void 0 : e.nonWitnessUtxo),
    typeof c == 'string' && (c = _t.decode(c)),
    c === void 0 && (c = e == null ? void 0 : e.txid)
  let u = { ...e, ...t, nonWitnessUtxo: s, txid: c }
  !('nonWitnessUtxo' in t) && u.nonWitnessUtxo === void 0 && delete u.nonWitnessUtxo,
    u.sequence === void 0 && (u.sequence = $c),
    u.tapMerkleRoot === null && delete u.tapMerkleRoot,
    (u = Fa(as, u, e, n, o)),
    Lc.encode(u)
  let f
  return (
...
const Cg = (t) => Math.ceil(t / 4),
  li = new Uint8Array(32),
  Ug = {
...
function Ki(t) {
  if (Array.isArray(t)) return t.map((e) => Ki(e))
  if (Ut(t)) return Uint8Array.from(t)
  if (['number', 'bigint', 'boolean', 'string', 'undefined'].includes(typeof t)) return t
  if (t === null) return t
  if (typeof t == 'object') return Object.fromEntries(Object.entries(t).map(([e, n]) => [e, Ki(n)]))
...
function Lg(t) {
  if (typeof t != 'number' || typeof yo[t] != 'string') throw new Error(`Invalid SigHash=${t}`)
  return t
}
function mf(t) {
  const e = t & 31
...
class jt {
  ...
  static fromRaw(e, n = {}) {
    const r = br.decode(e),
      o = new jt({ ...n, version: r.version, lockTime: r.lockTime })
    for (const s of r.outputs) o.addOutput(s)
    if (((o.outputs = r.outputs), (o.inputs = r.inputs), r.witnesses))
      for (let s = 0; s < r.witnesses.length; s++) o.inputs[s].finalScriptWitness = r.witnesses[s]
    return o
  }
  // PSBT
  static fromPSBT(e, n = {}) {
    ...
    const s = r.global.unsignedTx,
      c = o === 0 ? (s == null ? void 0 : s.version) : r.global.txVersion,
      u = o === 0 ? (s == null ? void 0 : s.lockTime) : r.global.fallbackLocktime,
      f = new jt({ ...n, version: c, lockTime: u, PSBTVersion: o }),
      h = o === 0 ? (s == null ? void 0 : s.inputs.length) : r.global.inputCount
    ...
    return (
      (f.outputs = r.outputs.slice(0, y).map((g, m) => {
        var b
        return {
          ...g,
      ...
      (f.global = { ...r.global, txVersion: c }),
      u !== zn && (f.global.fallbackLocktime = u),
      f
    )
  }
  toPSBT(e = this.opts.PSBTVersion) {
    ...
    for (const s of n)
      s.partialSig && !s.partialSig.length && delete s.partialSig,
        s.finalScriptSig && !s.finalScriptSig.length && delete s.finalScriptSig,
        s.finalScriptWitness && !s.finalScriptWitness.length && delete s.finalScriptWitness
    const r = this.outputs.map((s) => xf(e, Mi, s)),
      o = { ...this.global }
    return (
      e === 0
        ? ((o.unsignedTx = to.decode(
            to.encode({
        ...
        : ((o.version = e),
          ...
          o.fallbackLocktime && o.fallbackLocktime === zn && delete o.fallbackLocktime),
  ...
  get lockTime() {
    ...
    for (const s of this.inputs)
      s.requiredHeightLocktime && ((e = Math.max(e, s.requiredHeightLocktime)), n++),
        s.requiredTimeLocktime && ((r = Math.max(r, s.requiredTimeLocktime)), o++)
  ...
  get weight() {
    ...
    for (const r of this.inputs)
      (e += 160 + 4 * He.encode(r.finalScriptSig || Pt).length),
        this.hasWitnesses && r.finalScriptWitness && (e += Uc.encode(r.finalScriptWitness).length)
    return e
  }
  get vsize() {
  ...
  getOutputAddress(e, n = kr) {
    ...
    if (r.script) return wo(n).encode(fe.decode(r.script))
  }
  get outputsLength() {
  ...
  normalizeOutput(e, n, r) {
    ...
    if (
      (c.amount === void 0 && delete c.amount,
      (c = Fa(Mi, c, n, r, this.opts.allowUnknown)),
      Pc.encode(c),
      c.script && !this.opts.allowUnknownOutputs && fe.decode(c.script).type === 'unknown')
    )
      throw new Error(
  ...
  preimageLegacy(e, n, r) {
    ...
    if ((c && e >= this.outputs.length) || e >= this.inputs.length) return wl.encode(1n)
  ...
  preimageWitnessV0(e, n, r, o) {
    ...
    let f = li,
      h = li,
      y = li
    const g = this.inputs.map(Zr),
      m = this.outputs.map(Gn)
    s || (f = Oe(...g.map(ua.encode))),
      !s && !u && !c && (h = Oe(...g.map((U) => Bt.encode(U.sequence)))),
      !u && !c ? (y = Oe(...m.map(Jn.encode))) : u && e < m.length && (y = Oe(Jn.encode(m[e])))
    const b = g[e]
    return Oe(
      hr.encode(this.version),
      f,
      h,
      Lt(32, !0).encode(b.txid),
      Bt.encode(b.index),
      He.encode(n),
      gi.encode(o),
      Bt.encode(b.sequence),
      y,
  ...
  preimageWitnessV1(e, n, r, o, s = -1, c, u = 192, f) {
    ...
    const h = [
      ...
      y = r === Ct.DEFAULT ? Ct.ALL : r & 3,
      g = r & Ct.ANYONECANPAY,
      m = this.inputs.map(Zr),
      b = this.outputs.map(Gn)
    g !== Ct.ANYONECANPAY &&
      h.push(
        ...[m.map(ua.encode), o.map(gi.encode), n.map(He.encode), m.map((T) => Bt.encode(T.sequence))].map((T) =>
          Se(Bn(...T)),
        ),
      ),
      y === Ct.ALL && h.push(Se(Bn(...b.map(Jn.encode))))
    const U = (f ? 1 : 0) | (c ? 2 : 0)
    if ((h.push(new Uint8Array([U])), g === Ct.ANYONECANPAY)) {
      const T = m[e]
      h.push(ua.encode(T), gi.encode(o[e]), He.encode(n[e]), Bt.encode(T.sequence))
    } else h.push(Bt.encode(e))
    return (
      U & 1 && h.push(Se(He.encode(f || Pt))),
      y === Ct.SINGLE && h.push(e < b.length ? Se(Jn.encode(b[e])) : li),
      c && h.push(oo(c, u), Cn.encode(0), hr.encode(s)),
      pc('TapSighash', ...h)
    )
  }
  ...
  signIdx(e, n, r, o) {
    ...
    const s = this.inputs[n],
      c = wf(s, this.opts.allowLegacyWitnessUtxo)
    if (!Ut(e)) {
      if (!s.bip32Derivation || !s.bip32Derivation.length) throw new Error('bip32Derivation: empty')
      const y = s.bip32Derivation
        .filter((m) => m[1].fingerprint == e.fingerprint)
        .map(([m, { path: b }]) => {
          let U = e
          for (const T of b) U = U.deriveChild(T)
          if (!Yt(U.publicKey, m)) throw new Error('bip32Derivation: wrong pubKey')
    ...
    const u = c.sighash
    if (!r.includes(u)) throw new Error(`Input with not allowed sigHash=${u}. Allowed: ${r.join(', ')}`)
    const { sigOutputs: f } = this.inputSighash(n)
    if (f === Ct.SINGLE && n >= this.outputs.length)
      throw new Error(`Input with sighash SINGLE, but there is no output with corresponding index=${n}`)
    const h = mi(s)
    if (c.txType === 'taproot') {
      const y = this.inputs.map(mi),
        g = y.map((v) => v.script),
        m = y.map((v) => v.amount)
      let b = !1,
        U = hc(e),
        T = s.tapMerkleRoot || Pt
      if (s.tapInternalKey) {
        const { pubKey: v, privKey: I } = Og(e, U, s.tapInternalKey, T),
          [O, M] = xl(s.tapInternalKey, T)
        if (Yt(O, v)) {
          const j = this.preimageWitnessV1(n, g, u, m),
            G = Bn(Du(j, I, o), u !== Ct.DEFAULT ? new Uint8Array([u]) : Pt)
      ...
      if (s.tapLeafScript) {
        ...
        for (const [v, I] of s.tapLeafScript) {
          const O = I.subarray(0, -1),
            M = bt.decode(O),
            j = I[I.length - 1],
            G = oo(O, j)
          if (M.findIndex((P) => Ut(P) && Yt(P, U)) === -1) continue
          const z = this.preimageWitnessV1(n, g, u, m, void 0, O, j),
            tt = Bn(Du(z, e, o), u !== Ct.DEFAULT ? new Uint8Array([u]) : Pt)
      ...
      let g = !1
      const m = bl(y)
      for (const T of bt.decode(c.lastScript)) Ut(T) && (Yt(T, y) || Yt(T, m)) && (g = !0)
      if (!g) throw new Error(`Input script doesn't have pubKey: ${c.lastScript}`)
      let b
      if (c.txType === 'legacy') b = this.preimageLegacy(n, c.lastScript, u)
      else if (c.txType === 'segwit') {
        let T = c.lastScript
        c.last.type === 'wpkh' && (T = fe.encode({ type: 'pkh', hash: c.last.hash })),
          (b = this.preimageWitnessV0(n, T, u, h.amount))
      } else throw new Error(`Transaction/sign: unknown tx type: ${c.txType}`)
  ...
  finalizeIdx(e) {
    ...
    const n = this.inputs[e],
      r = wf(n, this.opts.allowLegacyWitnessUtxo)
    if (r.txType === 'taproot') {
      if (n.tapKeySig) n.finalScriptWitness = [n.tapKeySig]
        ...
        for (const [h, y] of f) {
          const g = y.slice(0, -1),
            ...
            b = fe.decode(g),
            U = oo(g, m),
            T = n.tapScriptSig.filter((I) => Yt(I[0].leafHash, U))
          let v = []
          if (b.type === 'tr_ms') {
            const I = b.m,
              O = b.pubkeys
    ...
    else if (r.last.type === 'wpkh') (o = Pt), (s = [n.partialSig[0][1], n.partialSig[0][0]])
  ...
  combine(e) {
    ...
    const n = this.global.unsignedTx ? to.encode(this.global.unsignedTx) : Pt,
      r = e.global.unsignedTx ? to.encode(e.global.unsignedTx) : Pt
    if (!Yt(n, r)) throw new Error('Transaction/combine: different unsigned tx')
...
const Ma = Ie(Lt(null), (t) => Ar(t, Ee.ecdsa)),
  Di = Ie(Lt(32), (t) => Ar(t, Ee.schnorr)),
  bf = Ie(Lt(null), (t) => {
  ...
  Kg = Lt(78),
  Dg = se({ pubKey: Di, leafHash: Lt(32) }),
  Mg = se({
    version: Cn,
    // With parity :(
    internalKey: Lt(32),
  ...
  Vg = ['partialSig', 'finalScriptSig', 'finalScriptWitness', 'tapKeySig', 'tapScriptSig'],
  Mi = {
  ...
  return Be({
    encodeStream: (n, r) => {
      ...
      for (const s in t) {
        ...
        const [u, f, h] = t[s]
        if (!f) o.push({ key: { type: u, key: Pt }, value: h.encode(c) })
        else {
          const y = c.map(([g, m]) => [f.encode(g), h.encode(m)])
          y.sort((g, m) => Bi(g[0], m[0]))
          for (const [g, m] of y) o.push({ key: { key: g, type: u }, value: m })
        }
      }
      if (r.unknown) {
        r.unknown.sort((s, c) => Bi(s[0].key, c[0].key))
        for (const [s, c] of r.unknown) o.push({ key: s, value: c })
      }
      Ef.encodeStream(n, o)
    },
    decodeStream: (n) => {
      const r = Ef.decodeStream(n),
        o = {},
        s = {}
      for (const c of r) {
        let u = 'unknown',
        ...
        if (e[c.key.type]) {
          ...
          if (((f = g ? g.decode(f) : void 0), (h = m.decode(h)), !g)) {
            if (o[u]) throw new Error(`PSBT: Same keys: ${u} (key=${f} value=${h})`)
            ;(o[u] = h), (s[u] = !0)
            continue
          }
...
const Lc = Ie(Oc(as), (t) => {
    ...
    if (t.partialSig) for (const [e] of t.partialSig) Ar(e, Ee.ecdsa)
    if (t.bip32Derivation) for (const [e] of t.bip32Derivation) Ar(e, Ee.ecdsa)
...
function cd(t) {
  ...
  fa(e, Rc, t.global)
  for (const c of t.inputs) fa(e, as, c)
  for (const c of t.outputs) fa(e, Mi, c)
...
function Fa(t, e, n, r, o) {
  ...
  for (const c in t) {
    ...
    if (e[c] === void 0 && c in e) {
      if (g) throw new Error(`Cannot remove signed field=${c}`)
      delete s[c]
    } else if (h) {
      const m = n && n[c] ? n[c] : []
      let b = e[u]
      if (b) {
        if (!Array.isArray(b)) throw new Error(`keyMap(${c}): KV pairs should be [k, v][]`)
        b = b.map((v) => {
        ...
        const U = {},
          T = (v, I, O) => {
            ...
            const M = _t.encode(y.encode(U[v][1])),
              j = _t.encode(y.encode(O))
            if (M !== j) throw new Error(`keyMap(${u}): same key=${v} oldVal=${M} newVal=${j}`)
          }
        for (const [v, I] of m) {
        ...
        for (const [v, I] of b) {
          const O = _t.encode(h.encode(v))
          if (I === void 0) {
            if (g) throw new Error(`Cannot remove signed field=${u}/${v}`)
            delete U[O]
          } else T(O, v, I)
        }
        s[u] = Object.values(U)
...
const Wg = {
  ...
  oy = [Gg, Wg, Yg, Zg, Xg, Qg, Jg, ty, ey, ny, ry],
  iy = $n(bt, Zi.match(oy)),
  fe = Ie(iy, (t) => {
    if (t.type === 'pk' && !gr(t.pubkey, Ee.ecdsa)) throw new Error('OutScript/pk: wrong key')
    ...
    if (t.type === 'ms') {
      ...
      for (const n of t.pubkeys) if (!gr(n, Ee.ecdsa)) throw new Error('OutScript/multisig: wrong pubkey')
      if (t.m <= 0 || e > 16 || t.m > e) throw new Error('OutScript/multisig: invalid params')
    }
    if (t.type === 'tr_ns' || t.type === 'tr_ms') {
      for (const e of t.pubkeys) if (!gr(e, Ee.schnorr)) throw new Error(`OutScript/${t.type}: wrong pubkey`)
    }
    if (t.type === 'tr_ms') {
      const e = t.pubkeys.length
...
function kf(t, e) {
  if (!Yt(t.hash, Se(e))) throw new Error('checkScript: wsh wrong witnessScript hash')
  const n = fe.decode(e)
...
function ay(t, e, n = !1, r) {
  ...
  if (!n && s.pubkeys)
    for (const c of s.pubkeys) {
      if (Yt(c, gc)) throw new Error('Unspendable taproot key in leaf script')
...
function ja(t, e, n = !1, r) {
  ...
  if ((Array.isArray(t) && t.length === 1 && (t = t[0]), !Array.isArray(t))) {
    ...
    if (!Ut(y)) throw new Error(`checkScript: wrong script type=${y}`)
    return (
      ay(y, e, n),
      {
        type: 'leaf',
...
const Hi = 192,
  oo = (t, e = Hi) => pc('TapLeaf', new Uint8Array([e]), He.encode(t))
function ld(t, e, n = kr, r = !1, o) {
  ...
  if (!gr(s, Ee.schnorr)) throw new Error('p2tr: non-schnorr pubkey')
  let c = e ? Va(ja(e, s, r)) : void 0
  const u = c ? c.hash : void 0,
    [f, h] = xl(s, u || Pt)
  let y
  c &&
    (y = qa(c).map((b) => ({
  ...
  let g
  y && (g = y.map((b) => [Nn.decode(b.controlBlock), Bn(b.script, new Uint8Array([b.version || Hi]))]))
  const m = {
    type: 'tr',
...
function wo(t = kr) {
  return {
    encode(e) {
      const { type: n } = e
      if (n === 'wpkh') return la(0, e.hash, t)
      if (n === 'wsh') return la(0, e.hash, t)
      if (n === 'tr') return la(1, e.pubkey, t)
      if (n === 'pkh') return Tf(e.hash, [t.pubKeyHash])
      if (n === 'sh') return Tf(e.hash, [t.scriptHash])
    ...
    decode(e) {
      ...
      if (t.bech32 && e.toLowerCase().startsWith(`${t.bech32}1`)) {
        let r
        try {
          if (((r = ka.decode(e)), r.words[0] !== 0)) throw new Error(`bech32: wrong version=${r.words[0]}`)
        } catch {
        ...
        const [o, ...s] = r.words,
          c = ka.fromWords(s)
        if ((hd(o, c), o === 0 && c.length === 32)) return { type: 'wsh', hash: c }
        if (o === 0 && c.length === 20) return { type: 'wpkh', hash: c }
        if (o === 1 && c.length === 32) return { type: 'tr', pubkey: c }
...
const uy = new Ot('leaf not found in tx tree'),
  fy = new Ot('parent not found')
class ly {
  constructor(e) {
    this.tree = e
  }
    ...
    for (let e = 1; e < this.tree.length; e++)
      for (const n of this.tree[e]) {
        const r = jt.fromPSBT(ve.decode(n.tx)),
          o = ht.encode(Oe(r.toBytes(!0)).reverse())
        if (o !== n.txid) throw new Ot(`node ${n.txid} has txid ${n.txid}, but computed txid is ${o}`)
        try {
          this.findParent(n)
        } catch (s) {
...
function dy(t) {
  if (t.length < da.length) return !1
  for (let e = 0; e < da.length; e++) if (t[e] !== da[e]) return !1
  return !0
}
function pd(t) {
  const e = [],
  ...
  for (const r of n.unknown) dy(new Uint8Array([r[0].type, ...r[0].key])) && e.push(r[1])
  return e
}
...
class mo {
  ...
  generateNonces() {
    if (!this.tree) throw ha
    const e = [],
      n = po.getPublicKey(this.secretKey)
  ...
  signPartial(e, n, r) {
    if (!this.tree || !this.scriptRoot || !this.rootSharedOutputAmount) throw mo.NOT_INITIALIZED
...
function hy(t, e, n, r) {
  const o = bt.encode(['OP_1', t.slice(1)]),
    s = e.levels[0][0]
  if (!s) throw new Error('empty vtxo tree')
...
class Fi {
  ...
  async sign(e, n) {
    const r = e.clone()
    if (!n) {
      if (!r.sign(this.key, void 0, If)) throw new Error('Failed to sign transaction')
      return r
    }
    for (const o of n) if (!r.signIdx(this.key, o, void 0, If)) throw new Error(`Failed to sign input #${o}`)
    return r
  }
  xOnlyPublicKey() {
    return hc(this.key)
  ...
  function s(u) {
    ...
    for (let g = 0; g < f.length; g++) {
      ...
      if (typeof m != 'string' && typeof m != 'number') {
        ...
        if (g === f.length - 2 && b !== 'CHECKSIG') throw new Error('Last operation must be CHECKSIG')
        g++
        continue
      }
    }
...
;(function (t) {
  function e(o) {
    ...
    const c = [
        Ur().encode(
          BigInt(
            pf.encode(
              o.timelock.type === 'blocks'
                ? { blocks: Number(o.timelock.value) }
                : { seconds: Number(o.timelock.value) },
            ),
          ),
        ),
        'CHECKSEQUENCEVERIFY',
      ...
      u = qe.encode(o),
      f = new Uint8Array([...bt.encode(c), ...u.script])
    return {
      type: Zt.CSVMultisig,
      params: o,
      script: f,
  ...
  function n(o) {
    ...
    const h = Number(Ur().decode(c)),
      y = pf.decode(h),
      g =
        y.blocks !== void 0
          ? { type: 'blocks', value: BigInt(y.blocks) }
          : { type: 'seconds', value: BigInt(y.seconds) },
      m = e({
        timelock: g,
        ...f.params,
      })
...
;(function (t) {
  function e(o) {
    const s = new Uint8Array([...o.conditionScript, ...bt.encode(['VERIFY']), ...qe.encode(o).script])
    return {
...
;(function (t) {
  function e(o) {
    const c = [Ur().encode(o.absoluteTimelock), 'CHECKLOCKTIMEVERIFY', 'DROP'],
      u = bt.encode(c),
      f = new Uint8Array([...u, ...qe.encode(o).script])
    return {
...
class $r {
  ...
  constructor(e) {
    this.scripts = e
    const n = fd(e.map((o) => ({ script: o, leafVersion: Hi }))),
      r = ld(gc, n, void 0, !0)
  ...
  class e extends $r {
    constructor(r) {
      const {
          ...
          preimageHash: u,
          refundLocktime: f,
          unilateralClaimDelay: h,
          unilateralRefundDelay: y,
          unilateralRefundWithoutReceiverDelay: g,
        } = r,
        m = py(u),
        b = qi.encode({
          conditionScript: m,
      ...
      super([b, U, T, v, I, O]),
        (this.options = r),
        (this.claimScript = ht.encode(b)),
        (this.refundScript = ht.encode(U)),
        (this.refundWithoutReceiverScript = ht.encode(T)),
        (this.unilateralClaimScript = ht.encode(v)),
        (this.unilateralRefundScript = ht.encode(I)),
        (this.unilateralRefundWithoutReceiverScript = ht.encode(O))
    }
    claim() {
...
;(function (t) {
  class e extends $r {
    constructor(r) {
      const { pubKey: o, serverPubKey: s, csvTimelock: c = e.DEFAULT_TIMELOCK } = r,
        u = qe.encode({
          pubkeys: [o, s],
        }).script,
        f = yn.encode({
...
function yd(t, e, n) {
  ...
  for (const c of [...t, ...e]) {
    ...
    o = _f(o, u)
    const f = di(u)
    if (c.value <= f) continue
    const h = yy(o, c)
    o = _f(o, h)
    const y = di(h)
    if (c.value <= y) continue
    const g = {
    ...
    c.virtualStatus.state === 'pending' && ((g.redeemTxid = c.txid), c.spentBy && (m = !0)),
      r.push({
        key: g,
        amount: c.value - f - y,
        type: Eo.TxReceived,
  ...
  for (const [c, u] of s) {
    ...
    g.virtualStatus.state === 'pending' && (m.redeemTxid = g.txid),
      r.push({
        key: m,
        amount: y - h,
        type: Eo.TxSent,
...
class Nf {
  ...
  static parse(e) {
    if (!e.toLowerCase().startsWith('bitcoin:')) throw new Error(za.INVALID_URI)
...
function by(t, e) {
  const n = [...t].sort((c, u) => u.value - c.value),
    r = []
  let o = 0
...
function vy(t, e) {
  const n = [...t].sort((c, u) => {
      const f = c.virtualStatus.batchExpiry || Number.MAX_SAFE_INTEGER,
        h = u.virtualStatus.batchExpiry || Number.MAX_SAFE_INTEGER
            ...
            if (g)
              try {
                const m = JSON.parse(g),
                  b = this.parseSettlementEvent(m.result)
                b && (yield b)
              } catch (m) {
...
class Kt {
  ...
  vsize() {
    const e = (c) => (c < 253 ? 1 : c < 65535 ? 3 : c < 4294967295 ? 5 : 9),
      n = e(this.inputCount),
...
const Ny = (t) => {
  ...
  Cy = new Ot('invalid settlement transaction'),
  Ga = new Ot('invalid settlement transaction outputs'),
  bd = new Ot('empty tree'),
  Uy = new Ot('invalid root level'),
  Dc = new Ot('invalid number of inputs'),
  io = new Ot('wrong settlement txid'),
  Wa = new Ot('invalid amount'),
  $y = new Ot('no leaves'),
  Ry = new Ot('node transaction empty'),
  Oy = new Ot('node txid empty'),
  Ly = new Ot('node parent txid empty'),
  Py = new Ot('node txid different'),
  Cf = new Ot('parent txid input mismatch'),
  Ky = new Ot('leaf node has children'),
  Uf = new Ot('invalid taproot script'),
  Dy = new Ot('invalid internal key')
new Ot('invalid control block')
const My = new Ot('invalid root transaction'),
  Hy = new Ot('invalid node transaction'),
  pa = 0,
  $f = 1
function Fy(t, e) {
  e.validate()
  ...
  if (!n) throw bd
  const r = jt.fromPSBT(ve.decode(n.tx))
  if (r.inputsLength !== 1) throw Dc
  const o = r.getInput(0),
    s = jt.fromPSBT(ve.decode(t))
  if (s.outputsLength <= $f) throw Ga
  const c = ht.encode(Oe(s.toBytes(!0)).reverse())
  if (!o.txid || ht.encode(o.txid) !== c || o.index !== $f) throw io
}
function Vy(t, e, n) {
  e.validate()
  let r
  ...
  if (r.outputsLength <= pa) throw Ga
  const o = r.getOutput(pa)
  if (!(o != null && o.amount)) throw Ga
  const s = o.amount
  if (e.numberOfNodes() === 0) throw bd
  if (e.levels[0].length !== 1) throw Uy
  ...
  if (f.inputsLength !== 1) throw Dc
  const h = f.getInput(0)
  if (!h.txid || h.index === void 0) throw io
  const y = ht.encode(Oe(r.toBytes(!0)).reverse())
  if (ht.encode(h.txid) !== y || h.index !== pa) throw io
  let g = 0n
  ...
  if (g >= s) throw Wa
  if (e.leaves().length === 0) throw $y
  for (const m of e.levels) for (const b of m) qy(e, b, n)
}
function qy(t, e, n) {
  if (!e.tx) throw Ry
  if (!e.txid) throw Oy
  if (!e.parentTxid) throw Ly
  let r
  try {
  ...
  if (ht.encode(Oe(r.toBytes(!0)).reverse()) !== e.txid) throw Py
  if (r.inputsLength !== 1) throw Dc
  const s = r.getInput(0)
  if (!s.txid || ht.encode(s.txid) !== e.parentTxid) throw Cf
  const c = t.children(e.txid)
  if (e.leaf && c.length >= 1) throw Ky
  for (let u = 0; u < c.length; u++) {
    const f = c[u],
      h = jt.fromPSBT(ve.decode(f.tx)),
      y = r.getOutput(u)
    if (!(y != null && y.script)) throw Uf
    const g = y.script.slice(2)
    if (g.length !== 32) throw Uf
    const m = pd(h),
      { finalKey: b } = Nc(m, !0, {
        taprootTweak: n,
      })
    if (ht.encode(b) !== ht.encode(g.slice(2))) throw Dy
    let U = 0n
    for (let T = 0; T < h.outputsLength; T++) {
      const v = h.getOutput(T)
      v != null && v.amount && (U += v.amount)
    }
    if (!y.amount || U >= y.amount) throw Wa
  }
}
const jy = 255
...
function Yy(t) {
  const e = []
  e.push(Rf(t.length))
  for (const s of t) e.push(new Uint8Array([1])), e.push(new Uint8Array([192])), e.push(Rf(s.length)), e.push(s)
  const n = e.reduce((s, c) => s + c.length, 0),
    r = new Uint8Array(n)
  let o = 0
  for (const s of e) r.set(s, o), (o += s.length)
  return r
}
function Rf(t) {
...
class ln {
  ...
  static decode(e) {
    ...
    const n = Mc.decode(e.subarray(0, 12)),
      r = e.subarray(12)
...
class pn {
  ...
  static async create(e) {
    const n = Ey(e.network),
      r = new Ay(e.esploraUrl || Sy[e.network]),
      o = e.identity.xOnlyPublicKey()
    if (!o) throw new Error('Invalid configured public key')
    let s
  ...
  async sendOnchain(e) {
    const n = await this.getCoins(),
      r = e.feeRate || pn.FEE_RATE,
      o = Math.ceil(174 * r),
      s = e.amount + o,
      c = by(n, s)
    if (!c.inputs) throw new Error('Insufficient funds')
    let u = new jt()
  ...
  async sendOffchain(e, n = !0) {
    ...
    const r = await this.getVirtualCoins(),
      o = n ? 0 : Math.ceil(174 * (e.feeRate || pn.FEE_RATE)),
      s = e.amount + o,
      c = vy(r, s)
    if (!c || !c.inputs) throw new Error('Insufficient funds')
  ...
  async settle(e, n) {
    ...
    if (!e) {
      ...
      const U = [...m, ...b]
      if (U.length === 0) throw new Error('No inputs found')
      e = {
        inputs: U,
        outputs: [
          {
  ...
  async handleSettlementSigningEvent(e, n, r) {
    ...
    const s = ve.decode(e.unsignedSettlementTx),
      u = jt.fromPSBT(s).getOutput(0)
    if (!(u != null && u.amount)) throw new Error('Shared output not found')
  ...
  async handleSettlementFinalizationEvent(e, n, r) {
    if (!this.arkProvider) throw new Error('Ark provider not configured')
    const o = wo(this.network).decode(r.forfeitAddress),
      s = fe.encode(o),
      c = [],
      u = await this.getVirtualCoins()
    let f = jt.fromPSBT(ve.decode(e.roundTx)),
      h = !1,
      y = !1
    for (const g of n) {
      ...
      const b = Nn.encode(g.tapLeafScript[0]),
        U = gd(Kc(g.tapLeafScript)),
        T = Kt.create()
          .addKeySpendInput()
          .addTapscriptInput(
            U.witnessSize(100),
        ...
        I = e.connectorsIndex.get(`${m.txid}:${m.vout}`)
      if (!I) throw new Error('Connector outpoint not found')
      let O
      for (const j of v)
        if (j.txid === I.txid)
          try {
      ...
      if (!O || !O.amount || !O.script) throw new Error('Connector output not found')
      let M = _y({
        connectorInput: I,
  ...
  async processVtxoSubscription({ address: e, scripts: n }) {
    try {
      const r = [...n.exit, ...n.forfeit],
        s = vo.Script.decode(r).findLeaf(n.forfeit[0]),
        c = new AbortController(),
        u = this.arkProvider.subscribeForAddress(e, c.signal)
  ...
  async handleGetBalance(e) {
    ...
    try {
      const u = await this.wallet.getCoins(),
        f = u.filter((v) => v.status.confirmed).reduce((v, I) => v + I.value, 0),
        h = u.filter((v) => !v.status.confirmed).reduce((v, I) => v + I.value, 0),
        y = f + h,
        g = await this.vtxoRepository.getSpendableVtxos(),
        m = g.reduce((v, I) => (I.virtualStatus.state === 'settled' ? v + I.value : v), 0),
        b = g.reduce((v, I) => (I.virtualStatus.state === 'pending' ? v + I.value : v), 0),
        U = g.reduce((v, I) => (I.virtualStatus.state === 'swept' ? v + I.value : v), 0),
        T = m + b + U
      ;(s = e.source) == null ||
        s.postMessage(
          wt.balance(n.id, {
    ...
    Of ||
      ...
      (function (t, e) {
        ;(function (n, r) {
          ...
          function o(i, a, l) {
            for (var d, p = 0, w = a.length; p < w; p++)
              (!d && p in a) || ((d = d || Array.prototype.slice.call(a, 0, p))[p] = a[p])
            return i.concat(d || Array.prototype.slice.call(a))
          }
          var s = typeof globalThis < 'u' ? globalThis : typeof self < 'u' ? self : typeof window < 'u' ? window : kg,
            c = Object.keys,
            u = Array.isArray
          function f(i, a) {
            return (
          ...
          function U(i, a, l, d) {
            b(
              ...
              a,
              f(
                l && g(l, 'get') && typeof l.get == 'function'
              ...
              if (typeof a != 'string' && 'length' in a) {
                ...
                x !== -1
                  ? ((w = a.substr(0, x)),
                    (E = a.substr(x + 1)) === ''
                      ? l === void 0
                        ? u(i) && !isNaN(parseInt(w))
                          ? i.splice(w, 1)
                          : delete i[w]
                        : (i[w] = l)
                      : z((x = !(x = i[w]) || !g(i, w) ? (i[w] = {}) : x), E, l))
                  : l === void 0
                  ? u(i) && !isNaN(parseInt(a))
                    ? i.splice(a, 1)
                    : delete i[a]
                  : (i[a] = l)
              }
          ...
          var q = typeof Symbol < 'u' ? Symbol.iterator : '@@iterator',
            et =
              typeof q == 'symbol'
                ? function (i) {
                    var a
...
`)
 ...
 ` + w
                    ...
                    : ((this.message = Dt[a] || l), (this.inner = null))
              }
          ...
          function vd(i, a) {
            return i === pt
              ...
              : function () {
                  ...
                  return (
                    d && (this.onsuccess = this.onsuccess ? Mt(d, this.onsuccess) : d),
                    p && (this.onerror = this.onerror ? Mt(p, this.onerror) : p),
                    w !== void 0 ? w : l
                  )
                }
          }
            ...
            return i === pt
              ...
              : function (l) {
                  ...
                  return (
                    ...
                    p && (this.onsuccess = this.onsuccess ? Mt(p, this.onsuccess) : p),
                    w && (this.onerror = this.onerror ? Mt(w, this.onerror) : w),
                    d === void 0 ? (l === void 0 ? void 0 : l) : f(d, l)
                  )
                }
          }
          function Sd(i, a) {
          ...
          var Rr = {},
            ...
            Uo = [],
            ls = ce,
            wn = { id: 'global', global: !0, ref: 0, unhandleds: [], onunhandled: pt, pgp: !1, env: {}, finalize: pt },
            ut = wn,
            Pr = [],
            Dn = 0,
            $o = []
          function rt(i) {
            ...
            if (typeof i != 'function') {
              ...
              return (
                ...
                void (this._state === !1 && hs(this, this._value))
              )
            }
            ;(this._state = null),
              (this._value = null),
          ...
          var ds = {
            get: function () {
              ...
              function l(d, p) {
                var w = this,
                  E = !i.global && (i !== ut || a !== Po),
                  x = E && !bn(),
                  A = new rt(function (B, C) {
          ...
          function or() {
            ...
            do
              for (; 0 < Pr.length; )
                for (i = Pr, Pr = [], l = i.length, a = 0; a < l; ++a) {
                  var d = i[a]
                  d[0].apply(null, d[1])
                }
            while (0 < Pr.length)
          ...
          m(rt.prototype, {
            ...
            typeof Symbol < 'u' && Symbol.toStringTag && U(rt.prototype, Symbol.toStringTag, 'Dexie.Promise'),
            (wn.env = zc()),
            m(rt, {
              all: function () {
          ...
          function mn(i, a, l, d) {
            ...
            return (
              ...
              (w.env = us
                ? {
                    Promise: rt,
                    PromiseProp: { value: rt, configurable: !0, writable: !0 },
                    all: rt.all,
                    race: rt.race,
                    allSettled: rt.allSettled,
                    any: rt.any,
                    resolve: rt.resolve,
                    reject: rt.reject,
                  }
          ...
          function Ko(i) {
            return Qt.echoes && i && i.constructor === Pn
              ? (ir(),
                i.then(
                  function (a) {
                    return bn(), a
          ...
          function vn(i, a) {
            var l,
              d = ut
            ;(a ? !Qt.echoes || (Lo++ && i === ut) : !Lo || (--Lo && i === ut)) ||
              queueMicrotask(
                a
                  ? function (p) {
                      ++Po,
                        (Qt.echoes && --Qt.echoes != 0) || (Qt.echoes = Qt.awaits = Qt.id = 0),
                        Oo.push(ut),
                        vn(p, !0)
                    }.bind(null, i)
                  : Bd,
              ...
              i !== ut &&
                ...
                us &&
                  ...
                  (a = i.env),
                  (d.global || i.global) &&
                    (Object.defineProperty(s, 'Promise', a.PromiseProp),
                    (l.all = a.all),
                    (l.race = a.race),
                    (l.resolve = a.resolve),
                    (l.reject = a.reject),
                    a.allSettled && (l.allSettled = a.allSettled),
                    a.any && (l.any = a.any))))
          }
          function zc() {
            var i = s.Promise
          ...
          var Ht = rt.reject,
            Hn = '￿',
            rn = 'Invalid key provided. Keys must be of type string, number, Date or Array<string | number | Date>.',
            Wc = 'String expected.',
            sr = [],
            Do = '__dbnames',
            ws = 'readonly',
          ...
          var Jc =
            ((Nt.prototype._trans = function (i, a, l) {
              var d = this._tx || ut.trans,
                p = this.name,
                w =
                  ze &&
                  typeof console < 'u' &&
                  console.createTask &&
                  console.createTask('Dexie: '.concat(i === 'readonly' ? 'read' : 'write', ' ').concat(this.name))
              function E(B, C, S) {
                  ...
                  d && d.db._novip === this.db._novip
                    ? d === ut.trans
                      ...
                      : mn(
                          ...
                          { trans: d, transless: ut.transless || ut },
                        )
                    : (function B(C, S, R, k) {
                        if (C.idbdb && (C._state.openComplete || ut.letThrough || C._vip)) {
                          ...
                          try {
                            ...
                            return $.name === Ke.InvalidState && C.isOpen() && 0 < --C._state.PR1398_maxLoop
            ...
            (Nt.prototype.where = function (i) {
              ...
              !l &&
                ze &&
                console.warn(
                  'The query '.concat(JSON.stringify(i), ' on ').concat(this.name, ' would benefit from a ') +
              ...
              var E = a.reduce(
                ...
                E = E[1]
              return w
                ? this.where(w.name).equals(i[w.keyPath]).filter(E)
                : l
                ? this.filter(E)
                : this.where(a).equals('')
            }),
            ...
            (Nt.prototype.mapToClass = function (i) {
              ...
              ;(this.schema.mappedClass = i).prototype instanceof Zc &&
                ((function (A, B) {
                ...
                Object.defineProperty(p.prototype, 'db', {
                  get: function () {
                    return l
                  },
                  enumerable: !1,
                ...
                (i = p))
              for (var w = /* @__PURE__ */ new Set(), E = i.prototype; E; E = h(E))
            ...
            (Nt.prototype.add = function (i, a) {
              ...
              return (
                w && p && (E = Mo(w)(i)),
                this._trans('readwrite', function (x) {
            ...
            (Nt.prototype.update = function (i, a) {
              return typeof i != 'object' || u(i)
                ? this.where(':id').equals(i).modify(a)
                : ((i = W(i, this.schema.primKey.keyPath)),
                  i === void 0
                    ? Ht(new it.InvalidArgument('Given object does not contain its primary key'))
                    : this.where(':id').equals(i).modify(a))
            }),
            ...
            (Nt.prototype.bulkAdd = function (i, a, l) {
              var d = this,
                ...
                w = (l = l || (p ? void 0 : a)) ? l.allKeys : void 0
              return this._trans('readwrite', function (E) {
                ...
                if (p && p.length !== i.length)
                  throw new it.InvalidArgument('Arguments objects and keys must have the same length')
                var A = i.length,
                  B = B && x ? i.map(Mo(B)) : i
            ...
            (Nt.prototype.bulkUpdate = function (i) {
              ...
              return this._trans('readwrite', function (E) {
                return l.getMany({ trans: E, keys: d, cache: 'clone' }).then(function (x) {
                  ...
                  var C = A.length
                  return l
                    .mutate({ trans: E, type: 'put', keys: A, values: B, updates: { keys: d, changeSpecs: p } })
                    .then(function (S) {
                      var R = S.numFailures,
                        k = S.failures
                      if (R === 0) return C
                      ...
                      throw new $t(
                        ''.concat(a.name, '.bulkUpdate(): ').concat(R, ' of ').concat(C, ' operations failed'),
                        k,
                      )
                    })
                })
              ...
              var w = {},
                E = function (x, A, B) {
                  ...
                  ;(p &&
                    ...
                    ((S = '' + (C = A.primaryKey)) == '[object ArrayBuffer]' && (S = '' + new Uint8Array(C)),
                    g(w, S) || ((w[S] = !0), a(x, A, B)))
                }
          ...
          var Mr =
            ((nu.prototype.execute = function (i) {
              var a = this['@@propmod']
              if (a.add !== void 0) {
                var l = a.add
              ...
              return (
                (l = (l = a.replacePrefix) === null || l === void 0 ? void 0 : l[0]),
                l && typeof i == 'string' && i.startsWith(l) ? a.replacePrefix[1] + i.substring(l.length) : i
              )
            }),
            nu)
          function nu(i) {
          ...
          var _d =
            ((Tt.prototype._read = function (i, a) {
              var l = this._ctx
            ...
            (Tt.prototype.count = function (i) {
              ...
              return this._read(function (l) {
                var d = a._ctx,
                  p = d.table.core
                if (ar(d, !0))
                  return p.count({ trans: l, query: { index: Ho(d, p.schema), range: d.range } }).then(function (E) {
            ...
            (Tt.prototype.toArray = function (i) {
              ...
              return this._read(function (l) {
                ...
                if (d.dir === 'next' && ar(d, !0) && 0 < d.limit) {
                  var p = d.valueMapper,
                    w = Ho(d, d.table.core.schema)
                  return d.table.core
                    .query({ trans: l, limit: d.limit, values: !0, query: { index: w, range: d.range } })
                    .then(function (x) {
            ...
            (Tt.prototype.filter = function (i) {
              var a
              return (
                bs(this._ctx, function (l) {
                  return i(l.value)
                }),
                ((a = this._ctx).isMatch = Fn(a.isMatch, i)),
                this
              )
            }),
            ...
            (Tt.prototype.primaryKeys = function (i) {
              var a = this._ctx
              if (a.dir === 'next' && ar(a, !0) && 0 < a.limit)
            ...
            (Tt.prototype.distinct = function () {
              var i = this._ctx,
                i = i.index && i.table.schema.idxByName[i.index]
              if (!i || !i.multi) return this
              var a = {}
              return (
                bs(this._ctx, function (p) {
                  var d = p.primaryKey.toString(),
                    p = g(a, d)
                  return (a[d] = !0), !p
                }),
                this
            ...
            (Tt.prototype.modify = function (i) {
              ...
              return this._write(function (d) {
                ...
                var x = l.table.core,
                  S = x.schema.primaryKey,
                  A = S.outbound,
                  B = S.extractKey,
                  C = 200,
                  S = a.db._options.modifyChunkSize
                ...
                return a
                  ...
                  .then(function (_) {
                    function L(D) {
                      ...
                      return x.getMany({ trans: d, keys: _.slice(D, D + F), cache: 'immutable' }).then(function (Y) {
                        for (var J = [], Z = [], X = A ? [] : null, nt = [], Q = 0; Q < F; ++Q) {
                          var st = Y[Q],
                            yt = { value: xt(st), primKey: _[D + Q] }
                          E.call(yt, yt.value, yt) !== !1 &&
                            (yt.value == null
                              ? nt.push(_[D + Q])
                              : A || At(B(st), B(yt.value)) === 0
                              ? (Z.push(yt.value), A && X.push(_[D + Q]))
                              : (nt.push(_[D + Q]), J.push(yt.value)))
                        }
                        return Promise.resolve(
                          ...
                          .then(function () {
                            return (
                              (0 < nt.length || (K && i === Es)) &&
                              x
                                .mutate({ trans: d, type: 'delete', keys: nt, criteria: K, isAdditionalChunk: 0 < D })
                                .then(function (vt) {
                    ...
                    var K = ar(l) &&
                      l.limit === 1 / 0 &&
                      (typeof i != 'function' || i === Es) && { index: l.index, range: l.range }
            ...
            (Tt.prototype.delete = function () {
              var i = this._ctx,
                a = i.range
              return ar(i) && (i.isPrimKey || a.type === 3)
                ...
                for (var D = null, F = k; F < S; ++F) {
                  var Y = (function (J, Z, X, nt, Q, st) {
                    for (var yt = Math.min(J.length, nt.length), vt = -1, Et = 0; Et < yt; ++Et) {
                      var Ce = Z[Et]
                      if (Ce !== nt[Et])
                        return Q(J[Et], X[Et]) < 0
                          ? J.substr(0, Et) + X[Et] + X.substr(Et + 1)
                          : Q(J[Et], nt[Et]) < 0
                          ? J.substr(0, Et) + nt[Et] + X.substr(Et + 1)
                          : 0 <= vt
                          ? J.substr(0, vt) + Z[vt] + X.substr(vt + 1)
                          : null
                      Q(J[Et], Ce) < 0 && (vt = Et)
                    }
                    return yt < nt.length && st === 'next'
                      ? J + X.substr(J.length)
                      : yt < J.length && st === 'prev'
                      ? J.substr(0, X.length)
                      : vt < 0
                      ? null
                      : J.substr(0, vt) + nt[vt] + X.substr(vt + 1)
                  })(L, K, x[F], A[F], E, B)
          ...
          var ou =
            (Object.defineProperty(Jt.prototype, 'Collection', {
              get: function () {
            ...
            (Jt.prototype.anyOf = function () {
              ...
              var p = 0
              return (
                d._addAlgorithm(function (w, E, x) {
            ...
            (Jt.prototype.noneOf = function () {
              ...
              return (
                a.push([i[i.length - 1], this.db._maxKey]), this.inAnyRange(a, { includeLowers: !1, includeUppers: !1 })
              )
            }),
            (Jt.prototype.inAnyRange = function (L, a) {
              ...
              var A = !a || a.includeLowers !== !1,
                B = a && a.includeUppers === !0,
                C,
                S = p
              function R(K, D) {
                return S(K[0], D[0])
              ...
              return (
                (L._ondirectionchange = function (K) {
          ...
          var Fr = 'storagemutated',
            xs = 'x-storagemutated-1',
            xn = Kr(null, Fr),
            Ud =
              ((We.prototype._lock = function () {
                return (
                  j(!ut.global), ++this._reculock, this._reculock !== 1 || ut.global || (ut.lockOwnerFor = this), this
                )
              }),
              (We.prototype._unlock = function () {
                if ((j(!ut.global), --this._reculock == 0))
                  for (ut.global || (ut.lockOwnerFor = null); 0 < this._blockedFuncs.length && !this._locked(); ) {
              ...
              (We.prototype.abort = function () {
                this.active &&
                  ((this.active = !1), this.idbtrans && this.idbtrans.abort(), this._reject(new it.Abort()))
              }),
              ...
              return {
                ...
                mutate: function ($) {
                  ...
                  return new Promise(function (Y, J) {
                    ...
                    if (L === 'deleteRange') {
                      ...
                      var X = nt ? (X ? [D, K] : [D, null]) : [K, null],
                        gt = X[0],
                        he = X[1]
                      if (nt)
                        for (var pe = 0; pe < st; ++pe)
                          vt.push((Q = he && he[pe] !== void 0 ? Z[L](gt[pe], he[pe]) : Z[L](gt[pe]))), (Q.onerror = yt)
                      else for (pe = 0; pe < st; ++pe) vt.push((Q = Z[L](gt[pe]))), (Q.onerror = yt)
                    }
                    function ni(be) {
                      ;(be = be.target.result),
                        vt.forEach(function (jn, Vs) {
                ...
                getMany: function ($) {
                  ...
                  return new Promise(function (K, D) {
                    ...
                    for (
                      ...
                      L[yt] != null && (((F = Y.get(L[yt]))._pos = yt), (F.onsuccess = Q), (F.onerror = st), ++X)
                    X === 0 && K(Z)
                  })
                },
                get: function ($) {
                  ...
                  function ($) {
                    return new Promise(function (_, L) {
                      ...
                      var K,
                        ...
                        Q = Q.range,
                        X = X.objectStore(N),
                        nt = nt.isPrimaryKey ? X : X.index(nt.name),
                        Q = d(Q)
                      if (J === 0) return _({ result: [] })
                      k
                        ? (((Z = Y ? nt.getAll(Q, Z) : nt.getAllKeys(Q, Z)).onsuccess = function (st) {
                            return _({ result: st.target.result })
                          }),
                          (Z.onerror = Ge(L)))
                        : ((K = 0),
                          (D = !Y && 'openKeyCursor' in nt ? nt.openKeyCursor(Q) : nt.openCursor(Q)),
                          (F = []),
                          (D.onsuccess = function (st) {
                            var yt = D.result
                            return yt
                              ? (F.push(Y ? yt.value : yt.primaryKey),
                                ++K === J ? _({ result: F }) : void yt.continue())
                              : _({ result: F })
                          }),
                          (D.onerror = Ge(L)))
                    })
                ...
                openCursor: function ($) {
                  ...
                  return new Promise(function (Y, J) {
                    ...
                    var nt = K.index,
                      Z = K.range,
                      X = _.objectStore(N),
                      X = nt.isPrimaryKey ? X : X.index(nt.name),
                      nt = D ? (F ? 'prevunique' : 'prev') : F ? 'nextunique' : 'next',
                      Q = !L && 'openKeyCursor' in X ? X.openKeyCursor(d(Z), nt) : X.openCursor(d(Z), nt)
                    ;(Q.onerror = Ge(J)),
                      (Q.onsuccess = Rt(function (st) {
                        var yt,
                          vt,
                          Et,
                          Ce,
                        ...
                        gt
                          ? ((gt.___id = ++$d),
                            (gt.done = !1),
                            (yt = gt.continue.bind(gt)),
                            (vt = (vt = gt.continuePrimaryKey) && vt.bind(gt)),
                            (Et = gt.advance.bind(gt)),
                            (Ce = function () {
                            ...
                            (gt.start = function (he) {
                              ...
                              return (
                                (Q.onsuccess = Rt(function (be) {
                                  ;(Q.onsuccess = pe), pe()
                                })),
                                (gt.continue = yt),
                                (gt.continuePrimaryKey = vt),
                                (gt.advance = Et),
                                pe(),
                                ni
                              )
                ...
                count: function ($) {
                  ...
                  return new Promise(function (F, Y) {
                    var J = L.objectStore(N),
                      Z = K.isPrimaryKey ? J : J.index(K.name),
                      J = d(D),
                      Z = J ? Z.count(J) : Z.count()
          ...
          function qo(i, d) {
            var l = d.db,
              d = Od(i._middlewares, l, i._deps, d)
            ;(i.core = d.dbcore),
              i.tables.forEach(function (p) {
                var w = p.name
                                ...
                                $.push(function () {
                                  ...
                                  if (Y && L._cfg.version > R) {
                                    ...
                                    F.del.forEach(function (nt) {
                                      ...
                                      Ts(S, [S.Transaction.prototype]),
                                      jo(S, [S.Transaction.prototype], c(J), J),
                                      (k.schema = J)
                                    var Z,
                                      X = St(Y)
                                    return (
                                      X && ir(),
                                      (F = rt.follow(function () {
                                        var nt
                                  ...
                                  $.push(function (K) {
                                    ...
                                    ;(D = Y),
                                      (F = K),
                                      [].slice.call(F.db.objectStoreNames).forEach(function (J) {
                                        return D[J] == null && F.db.deleteObjectStore(J)
                                      }),
                                      Ts(S, [S.Transaction.prototype]),
                                      jo(S, [S.Transaction.prototype], S._storeNames, S._dbSchema),
                                      (k.schema = S._dbSchema)
                                  }),
                                  $.push(function (K) {
                                    S.idbdb.objectStoreNames.contains('$meta') &&
                                      (Math.ceil(S.idbdb.version / 10) === L._cfg.version
                                        ? (S.idbdb.deleteObjectStore('$meta'),
                                          delete S._dbSchema.$meta,
                                          (S._storeNames = S._storeNames.filter(function (D) {
                                            return D !== '$meta'
                                          })))
            ...
            for (var d = 0, p = Is(l, i._dbSchema).change; d < p.length; d++) {
              var w = (function (E) {
                ...
                E.add.forEach(function (A) {
                  ze && console.debug('Dexie upgrade patch: Creating missing index '.concat(E.name, '.').concat(A.src)),
                    zo(x, A)
                })
              })(p[d])
          ...
          function Is(i, a) {
            ...
            for (l in a) {
              ...
              if (p) {
                ...
                if (
                  '' + (p.primKey.keyPath || '') != '' + (w.primKey.keyPath || '') ||
                  p.primKey.auto !== w.primKey.auto
                )
                  (E.recreate = !0), d.change.push(E)
                else {
                  var x = p.idxByName,
                    A = w.idxByName,
                    B = void 0
          ...
          function au(i, a) {
            c(i).forEach(function (l) {
              a.db.objectStoreNames.contains(l) ||
                (ze && console.debug('Dexie: Creating missing table', l), Bs(a, l, i[l].primKey, i[l].indexes))
            })
          }
          function zo(i, a) {
          ...
          function Go(i, a, l) {
            var d = {}
            return (
              O(a.objectStoreNames, 0).forEach(function (p) {
                for (
                  var w = l.objectStore(p),
                    E = Ss(iu((B = w.keyPath)), B || '', !0, !1, !!w.autoIncrement, B && typeof B != 'string', !0),
                    x = [],
                    A = 0;
                  A < w.indexNames.length;
                  ++A
                ) {
                  var C = w.index(w.indexNames[A]),
                    B = C.keyPath,
                    C = Ss(C.name, B, !!C.unique, !!C.multiEntry, !1, B && typeof B != 'string', !1)
                  x.push(C)
                }
                d[p] = As(p, E, x)
              }),
          ...
          function Wo(i, a, l) {
            for (var d = l.db.objectStoreNames, p = 0; p < d.length; ++p) {
              ...
              for (var x = 0; x < E.indexNames.length; ++x) {
                var A = E.indexNames[x],
                  B = E.index(A).keyPath,
                  C = typeof B == 'string' ? B : '[' + O(B).join('+') + ']'
          ...
          function cu(i) {
            return i.split(',').map(function (a, l) {
              var d = (a = a.trim()).replace(/([&*]|\+\+)/g, ''),
                p = /^\[/.test(d) ? d.match(/^\[(.*)\]$/)[1].split('+') : d
              return Ss(d, p || null, /\&/.test(a), /\*/.test(a), /\+\+/.test(a), u(p), l === 0)
            })
          }
          var Dd =
            ((Yo.prototype._parseStoresSpec = function (i, a) {
              c(i).forEach(function (l) {
                if (i[l] !== null) {
                  var d = cu(i[l]),
                    p = d.shift()
            ...
            (Yo.prototype.stores = function (l) {
              ...
              return (
                ...
                jo(a, [a._allTables, a, a.Transaction.prototype, this._cfg.tables], c(p), p),
                (a._storeNames = c(p)),
                this
              )
            }),
          ...
          function _s(i, a) {
            ...
            return (
              l ||
                (l = i._dbNamesDB = new on(Do, { addons: [], indexedDB: i, IDBKeyRange: a }))
                  .version(1)
                  .stores({ dbnames: 'name' }),
              l.table('dbnames')
            )
          ...
          function jr(i, a, l) {
            ...
            if (!isNaN(d)) {
              ...
              At(a, i.from) < 0 && ((i.from = a), (i.l = null), (i.d = d ? d.d + 1 : 1)),
                0 < At(l, i.to) && ((i.to = l), (i.r = null), (i.d = i.l ? i.l.d + 1 : 1)),
                (l = !i.r),
                p && !i.l && zr(i, p),
                d && l && zr(i, d)
            }
          ...
          function fu(i) {
            var a,
              l,
              d =
                (((a = i.r) === null || a === void 0 ? void 0 : a.d) || 0) -
                (((l = i.l) === null || l === void 0 ? void 0 : l.d) || 0),
              p = 1 < d ? 'r' : d < -1 ? 'l' : ''
            p &&
              ((a = p == 'r' ? 'l' : 'r'),
              (l = r({}, i)),
                ...
                i[l]
                  ...
                  : (i[l] = (function d(p) {
                      var w,
                        ...
                        x = {}
                      for (w in p)
                        g(p, w) && ((E = p[w]), (x[w] = !E || typeof E != 'object' || lt.has(E.constructor) ? E : d(E)))
                      return x
                    })(a[l]))
              }),
              i
          ...
          function du(i, a, l, d) {
            for (var p = [], w = 0, E = Object.entries(i.queries.query); w < E.length; w++) {
              for (var x = E[w], A = x[0], B = [], C = 0, S = x[1]; C < S.length; C++) {
                var R = S[C]
                $s(a, R.obsSet)
                  ? R.subscribers.forEach(function (_) {
                      return l.add(_)
                    })
                  : d && B.push(R)
              }
          ...
          function Md(i) {
            ...
            function x() {
              return new rt(function (R, k) {
                ...
                var N = i.name,
                  $ = a.autoSchema || !p ? l.open(N) : l.open(N, p)
                if (!$) throw new it.MissingAPI()
                ;($.onerror = Ge(k)),
                  ($.onblocked = Rt(i._fireOnBlocked)),
                  ($.onupgradeneeded = Rt(function (_) {
                    var L
                    ;(C = $.transaction),
                      a.autoSchema && !i._options.allowEmptyDB
                        ? (($.onerror = Hr),
                          C.abort(),
                          $.result.close(),
                          ((L = l.deleteDatabase(N)).onsuccess = L.onerror =
                            Rt(function () {
                              k(new it.NoSuchDatabase('Database '.concat(N, ' doesnt exist')))
                            })))
                        : ((C.onerror = Ge(k)),
                          (_ = _.oldVersion > Math.pow(2, 62) ? 0 : _.oldVersion),
                          (S = _ < 1),
                          (i.idbdb = $.result),
                          w && Kd(i, C),
                          Pd(i, _ / 10, C, k))
                  }, k)),
                  ($.onsuccess = Rt(function () {
                    C = null
                    var _,
                      L,
                      K,
                    ...
                    if (0 < J.length)
                      try {
                        ...
                        if (a.autoSchema)
                          (L = Y),
                            (K = Z),
                            ((_ = i).verno = L.version / 10),
                            (K = _._dbSchema = Go(0, L, K)),
                            (_._storeNames = O(L.objectStoreNames, 0)),
                            jo(_, [_._allTables], c(K), K)
                        else if (
                          (Wo(i, i._dbSchema, Z),
                          ((F = Is(Go(0, (F = i).idbdb, Z), F._dbSchema)).add.length ||
                            F.change.some(function (X) {
                    ...
                    sr.push(i),
                      (Y.onversionchange = Rt(function (X) {
                      ...
                      S &&
                        ...
                        (Y = F.indexedDB),
                        (F = F.IDBKeyRange),
                        Ns(Y) || Z === Do || _s(Y, F).put({ name: Z }).catch(pt)),
                      R()
                  }, k))
              }).catch(function (R) {
            ...
            return rt
              ...
              .then(function () {
                ...
                return (
                  S &&
                    ((R = {}),
                    i.tables.forEach(function (k) {
                      k.schema.indexes.forEach(function (N) {
                        N.name &&
                          (R['idb://'.concat(i.name, '/').concat(k.name, '/').concat(N.name)] = new de(-1 / 0, [[[]]]))
                      }),
                        (R['idb://'.concat(i.name, '/').concat(k.name, '/')] = R[
                          'idb://'.concat(i.name, '/').concat(k.name, '/:dels')
                        ] =
                          new de(-1 / 0, [[[]]]))
                    }),
                    xn(Fr).fire(R),
              ...
              return r(r({}, i), {
                table: function (a) {
                  ...
                  function E(S, R, k) {
                    var N = qr(S),
                      $ = (p[N] = p[N] || []),
                      _ = S == null ? 0 : typeof S == 'string' ? 1 : S.length,
                      L = 0 < R,
                      L = r(r({}, k), {
                        name: L ? ''.concat(N, '(virtual-from:').concat(k.name, ')') : k.name,
                        lowLevelIndex: k,
                        isVirtual: L,
                        keyTail: R,
                        keyLength: _,
                    ...
                    return (
                      $.push(L),
                      L.isPrimaryKey || w.push(L),
                      1 < _ && E(_ === 2 ? S[0] : S.slice(0, _ - 1), R + 1, k),
                      $.sort(function (K, D) {
                          ...
                          query: {
                            ...
                            range:
                              ...
                              (k = k.keyTail),
                              {
                                ...
                                lower: Jo(R.lower, R.lowerOpen ? i.MAX_KEY : i.MIN_KEY, k),
                                lowerOpen: !0,
                                upper: Jo(R.upper, R.upperOpen ? i.MIN_KEY : i.MAX_KEY, k),
                                upperOpen: !0,
                              }),
                          },
                        })
                  ...
                  return r(r({}, l), {
                    ...
                    openCursor: function (S) {
                      var R = S.query.index,
                        ...
                        $ = R.keyLength
                      return N
                        ? l.openCursor(C(S)).then(function (L) {
                            return L && _(L)
                          })
                        : l.openCursor(S)
                      function _(L) {
                        return Object.create(L, {
                          continue: {
                            value: function (K) {
                              K != null
                                ? L.continue(Jo(K, S.reverse ? i.MAX_KEY : i.MIN_KEY, k))
                                : S.unique
                                ? L.continue(L.key.slice(0, $).concat(S.reverse ? i.MIN_KEY : i.MAX_KEY, k))
                                : L.continue()
                            },
                          },
                          continuePrimaryKey: {
            ...
            return (
              ...
              c(i).forEach(function (p) {
                ...
                g(a, p)
                  ? ((w = i[p]),
                    (E = a[p]),
                    typeof w == 'object' && typeof E == 'object' && w && E
                      ? (x = V(w)) !== V(E)
                        ? (l[d + p] = a[p])
                        : x === 'Object'
                        ? Ks(w, E, l, d + p + '.')
                  ...
                  return r(r({}, l), {
                    mutate: function (p) {
                          ...
                          return w._promise(
                            ...
                            function () {
                              return (function S(R, k, N) {
                                return l
                                  .query({ trans: R, values: !1, query: { index: d, range: k }, limit: N })
                                  .then(function ($) {
                                    var _ = $.result
                                    return C({ type: 'delete', keys: _, trans: R }).then(function (L) {
                                      return 0 < L.numFailures
                                        ? Promise.reject(L.failures[0])
                                        : _.length < N
                                        ? { failures: [], numFailures: 0, lastResult: void 0 }
                                        : S(R, r(r({}, k), { lower: _[_.length - 1], lowerOpen: !0 }), N)
                                    })
                                  })
                              })(p.trans, p.range, 1e4)
                            },
                      ...
                      function C(S) {
                        ...
                        return (
                          (S = S.type === 'add' || S.type === 'put' ? r(r({}, S), { keys: _ }) : r({}, S)).type !==
                            'delete' && (S.values = o([], S.values)),
                          S.keys && (S.keys = o([], S.keys)),
                          (R = l),
                          (N = _),
                          ((k = S).type === 'add'
                            ? Promise.resolve([])
                            : R.getMany({ trans: k.trans, keys: N, cache: 'immutable' })
                          ).then(function (L) {
                            var K = _.map(function (D, F) {
                              var Y,
                                ...
                                Z,
                                X = L[F],
                                nt = { onerror: null, onsuccess: null }
                              return (
                                S.type === 'delete'
                                  ? x.fire.call(nt, D, X, $)
                                  : S.type === 'add' || X === void 0
                                  ? ((Y = A.fire.call(nt, D, S.values[F], $)),
                                    D == null &&
                                      Y != null &&
                                      ((S.keys[F] = D = Y), d.outbound || z(S.values[F], d.keyPath, D)))
                                  : ((Y = Ks(X, S.values[F])),
                                    (J = B.fire.call(nt, Y, D, X, $)) &&
                                      ((Z = S.values[F]),
                            ...
                            return l
                              ...
                              .then(function (D) {
                                for (
                                  var F = D.failures, Y = D.results, J = D.numFailures, D = D.lastResult, Z = 0;
                                  Z < _.length;
                                  ++Z
                                ) {
                                  var X = (Y || _)[Z],
                                    nt = K[Z]
                                  X == null
                                    ? nt.onerror && nt.onerror(F[Z])
                                    : nt.onsuccess && nt.onsuccess(S.type === 'put' && L[Z] ? S.values[Z] : X)
                                }
          ...
          function hu(i, a, l) {
            try {
              ...
              for (var d = [], p = 0, w = 0; p < a.keys.length && w < i.length; ++p)
                At(a.keys[p], i[w]) === 0 && (d.push(l ? xt(a.values[p]) : a.values[p]), ++w)
          ...
          var qd = {
            ...
            create: function (i) {
              var a = i.schema.name,
                l = new de(i.MIN_KEY, i.MAX_KEY)
              return r(r({}, i), {
                transaction: function (d, p, w) {
                  if (ut.subscr && p !== 'readonly')
                    throw new it.ReadOnly(
                      'Readwrite transaction in liveQuery context. Querier source: '.concat(ut.querier),
                    )
                ...
                table: function (d) {
                  var p = i.table(d),
                    ...
                    C = r(r({}, p), {
                      mutate: function (k) {
                        ...
                        var $,
                          ...
                          L,
                          K = k.trans,
                          D = k.mutatedParts || (k.mutatedParts = {}),
                          F = N(''),
                          Y = N(':dels'),
                          J = k.type,
                          nt =
                        ...
                        return (
                          u(Z)
                            ? (F.addKeys(Z),
                              (nt = J === 'delete' || Z.length === X.length ? hu(Z, nt) : null) || Y.addKeys(Z),
                              (nt || X) &&
                                (($ = N),
                                (_ = nt),
                                (L = X),
                                w.indexes.forEach(function (Q) {
                                  var st = $(Q.name || '')
                                  function yt(Et) {
                            ...
                            : Z
                            ? ((X = {
                                from: (X = Z.lower) !== null && X !== void 0 ? X : i.MIN_KEY,
                                to: (X = Z.upper) !== null && X !== void 0 ? X : i.MAX_KEY,
                              }),
                              Y.add(X),
                              F.add(X))
                            : (F.add(l),
                              ...
                              !Z ||
                                ...
                                B &&
                                  B.forEach(function (st) {
                                    for (
                                      var yt = k.values.map(function (gt) {
                                      ...
                                      yt[Et][vt] = Q.results[Et]
                                    N(st.name).addKeys(yt)
                                  })),
                              (K.mutatedParts = Xo(K.mutatedParts || {}, D)),
                              Q
                            )
                          })
                        )
                    ...
                    S = function (N) {
                      ...
                      return [
                        N,
                        new de(
                          (N = $.lower) !== null && N !== void 0 ? N : i.MIN_KEY,
                          ($ = $.upper) !== null && $ !== void 0 ? $ : i.MAX_KEY,
                        ),
                      ]
                    },
                    R = {
                  ...
                  return (
                    c(R).forEach(function (k) {
                      C[k] = function (N) {
                        var $ = ut.subscr,
                          _ = !!$,
                          L = pu(ut, p) && gu(k, N) ? (N.obsSet = {}) : $
                        if (_) {
                          var K = function (X) {
                            ...
                            $ = $[1]
                          if (
                            ((k === 'query' && _.isPrimaryKey && !N.values ? F : K(_.name || '')).add($),
                            !_.isPrimaryKey)
                          ) {
                            if (k !== 'count') {
          ...
          function yu(i, a, l) {
            ...
            return l.numFailures === d
              ? null
              : ((a = r({}, a)),
                u(a.keys) &&
                  (a.keys = a.keys.filter(function (p, w) {
                    return !(w in l.failures)
                  })),
                'values' in a &&
                  u(a.values) &&
                  (a.values = a.values.filter(function (p, w) {
                    return !(w in l.failures)
                  })),
                a)
          }
          function Ms(i, a) {
            return (
              (l = i),
              ((d = a).lower === void 0 || (d.lowerOpen ? 0 < At(l, d.lower) : 0 <= At(l, d.lower))) &&
                ((i = i), (a = a).upper === void 0 || (a.upperOpen ? At(i, a.upper) < 0 : At(i, a.upper) <= 0))
            )
            var l, d
          }
          function wu(i, a, R, d, p, w) {
            ...
            var E = a.query.index,
              x = E.multiEntry,
              A = a.query.range,
              B = d.schema.primaryKey.extractKey,
              C = E.extractKey,
              S = (E.lowLevelIndex || E).extractKey,
              R = R.reduce(function (k, N) {
                var $ = k,
                  _ = []
                if (N.type === 'add' || N.type === 'put')
                  for (var L = new de(), K = N.values.length - 1; 0 <= K; --K) {
                    var D,
                      F = N.values[K],
                      Y = B(F)
                    L.hasKey(Y) ||
            ...
            return R === i
              ...
              : (R.sort(function (k, N) {
                ...
                a.limit &&
                  ...
                  (R.length > a.limit
                    ? (R.length = a.limit)
                    : i.length === a.limit && R.length < a.limit && (p.dirty = !0)),
                w ? Object.freeze(R) : R)
          }
          function mu(i, a) {
            return (
              At(i.lower, a.lower) === 0 &&
              At(i.upper, a.upper) === 0 &&
            ...
            create: function (i) {
              ...
              return r(r({}, i), {
                transaction: function (l, d, p) {
                  var w,
                    E,
                    x = i.transaction(l, d, p)
                  return (
                    d === 'readwrite' &&
                      ((E = (w = new AbortController()).signal),
                      (p = function (A) {
                        return function () {
                          if ((w.abort(), d === 'readwrite')) {
                            for (var B = /* @__PURE__ */ new Set(), C = 0, S = l; C < S.length; C++) {
                              var R = S[C],
                                k = Vn['idb://'.concat(a, '/').concat(R)]
                              if (k) {
                                var N = i.table(R),
                                  $ = k.optimisticOps.filter(function (st) {
                                    return st.trans === x
                                  })
                                if (x._explicit && A && x.mutatedParts)
                                  for (var _ = 0, L = Object.values(k.queries.query); _ < L.length; _++)
                                    for (var K = 0, D = (J = L[_]).slice(); K < D.length; K++)
                                      $s((Z = D[K]).obsSet, x.mutatedParts) &&
                                        (ot(J, Z),
                                        Z.subscribers.forEach(function (st) {
                                          return B.add(st)
                                        }))
                                else if (0 < $.length) {
                                  ...
                                  for (var F = 0, Y = Object.values(k.queries.query); F < Y.length; F++)
                                    for (var J, Z, X, nt = 0, Q = (J = Y[F]).slice(); nt < Q.length; nt++)
                                      (Z = Q[nt]).res != null &&
                                        x.mutatedParts &&
                                        (A && !Z.dirty
                                          ? ((X = Object.isFrozen(Z.res)),
                                            (X = wu(Z.res, Z.req, $, N, Z, X)),
                                            Z.dirty
                                              ? (ot(J, Z),
                                                Z.subscribers.forEach(function (st) {
                                                  return B.add(st)
                                                }))
                                              : X !== Z.res && ((Z.res = X), (Z.promise = rt.resolve({ result: X }))))
                                          : (Z.dirty && ot(J, Z),
                                            Z.subscribers.forEach(function (st) {
                                              return B.add(st)
                                            })))
                      ...
                      x.addEventListener('abort', p(!1), { signal: E }),
                      x.addEventListener('error', p(!1), { signal: E }),
                      x.addEventListener('complete', p(!0), { signal: E })),
                    x
                  )
                },
                table: function (l) {
                  var d = i.table(l),
                    p = d.schema.primaryKey
                  return r(r({}, d), {
                    mutate: function (w) {
                      var E = ut.trans
                      if (
                      ...
                      return x
                        ? ((E = d.mutate(w)),
                          ...
                          !(
                            50 <= w.values.length ||
                            Ds(p, w).some(function (A) {
                              return A == null
                            })
                          )
                            ? (x.optimisticOps.push(w),
                              w.mutatedParts && Qo(w.mutatedParts),
                              E.then(function (A) {
                                0 < A.numFailures &&
                                  (ot(x.optimisticOps, w),
                                  (A = yu(0, w, A)) && x.optimisticOps.push(A),
                                  w.mutatedParts && Qo(w.mutatedParts))
                              }),
                              E.catch(function () {
                            ...
                            : E.then(function (A) {
                                var B = yu(
                                  0,
                                  r(r({}, w), {
                                    values: w.values.map(function (C, S) {
                                      var R
                                      return A.failures[S]
                                        ? C
                                        : ((C =
                                            (R = p.keyPath) !== null && R !== void 0 && R.includes('.')
                                              ? xt(C)
                                              : r({}, C)),
                                          z(C, p.keyPath, A.results[S]),
                                          C)
                                    }),
                                  }),
                                  A,
                                )
                                x.optimisticOps.push(B),
                    ...
                    query: function (w) {
                      ...
                      var E = ((B = ut.trans) === null || B === void 0 ? void 0 : B.db._options.cache) === 'immutable',
                        S = ut,
                        x = S.requery,
                        A = S.signal,
                        B = (function (N, $, _, L) {
                          ...
                          switch (_) {
                            case 'query':
                              var F = D.find(function (Y) {
                                return (
                                  Y.req.limit === L.limit &&
                                  Y.req.values === L.values &&
                                  mu(Y.req.query.range, L.query.range)
                                )
                              })
                              return F
                                ? [F, !0, K, D]
                                : [
                                    D.find(function (Y) {
                                      return (
                                        ('limit' in Y.req ? Y.req.limit : 1 / 0) >= L.limit &&
                                        (!L.values || Y.req.values) &&
                                        jd(Y.req.query.range, L.query.range)
                                      )
                                    }),
                                    !1,
                                    K,
                          ...
                          : ((S = d
                            ...
                            k
                              ...
                              : ((k = [C]),
                                ((R =
                                  R ||
                                  (Vn['idb://'.concat(a, '/').concat(l)] = {
                                    queries: { query: {}, count: {} },
                                    objs: /* @__PURE__ */ new Map(),
                                    optimisticOps: [],
                                    unsignaledParts: {},
                                  })).queries.query[w.query.index.name || ''] = k))),
                        zd(C, k, x, A),
          ...
          var on =
            ...
            (Ft.prototype.use = function (i) {
              ...
              return (
                ...
                (i = this._middlewares[a] || (this._middlewares[a] = [])),
                i.push({ stack: a, create: l, level: d ?? 10, name: p }),
                i.sort(function (w, E) {
            ...
            (Ft.prototype.close = function (l) {
              var a = (l === void 0 ? { disableAutoOpen: !0 } : l).disableAutoOpen,
                l = this._state
              a
                ? (l.isBeingOpened && l.cancelOpen(new it.DatabaseClosed()),
                  this._close(),
                  (l.autoOpen = !1),
                  (l.dbOpenError = new it.DatabaseClosed()))
                : (this._close(),
            ...
            (Ft.prototype.delete = function (i) {
              ...
              var l = 0 < arguments.length && typeof arguments[0] != 'object',
                d = this._state
                ...
                function E() {
                  ...
                  ;(x.onsuccess = Rt(function () {
                    ...
                    ;(A = a._deps),
                      ...
                      (C = A.indexedDB),
                      (A = A.IDBKeyRange),
                      Ns(C) || B === Do || _s(C, A).delete(B).catch(pt),
                      p()
                  })),
                    (x.onerror = Ge(w)),
                    (x.onblocked = a._fireOnBlocked)
                }
            ...
            (Ft.prototype.transaction = function () {
            ...
            (Ft.prototype._transaction = function (i, a, l) {
              ...
              try {
                if (
                  ((E = a.map(function (B) {
                    if (((B = B instanceof d.Table ? B.name : B), typeof B != 'string'))
                      throw new TypeError(
                ...
                return rt.resolve().then(function () {
                  ...
                  return (
                    ...
                    ($ = rt.follow(function () {
                      ...
                      ;(L = N.call(_, _)) &&
                        (K
                          ? ((D = bn.bind(null, null)), L.then(D, D))
                          : typeof L.next == 'function' && typeof L.throw == 'function' && (L = Ps(L)))
                    }, $)),
                    (L && typeof L.then == 'function'
                      ? rt.resolve(L).then(function (D) {
                          return _.active
                            ? D
                            : Ht(new it.PrematureCommit('Transaction committed too early. See http://bit.ly/2kdckMn'))
                        })
                      : $.then(function () {
                          return L
                        })
          ...
          function Ft(i, a) {
            ...
            ;(B.dbReadyPromise = new rt(function (S) {
              ...
              (this._state = B),
              (this.name = i),
              (this.on = Kr(this, 'populate', 'blocked', 'versionchange', 'close', { ready: [cs, pt] })),
              (this.on.ready.subscribe = M(this.on.ready.subscribe, function (S) {
                return function (R, k) {
                  Ft.vip(function () {
                    var N,
                      $ = l._state
                    $.openComplete
                      ? ($.dbOpenError || rt.resolve().then(R), k && S(R))
                      : $.onReadyBeingFired
                      ? ($.onReadyBeingFired.push(R), k && S(R))
                      : (S(R),
                        (N = l),
                        k ||
                          S(function _() {
              ...
              (this.Collection =
                ...
                Dr(_d.prototype, function (L, _) {
                  ...
                  var $ = L._ctx,
                    _ = $.table,
                    L = _.hook.reading.fire
                  this._ctx = {
                    table: _,
                    index: $.index,
                    isPrimKey: !$.index || (_.schema.primKey.keyPath && $.index === _.schema.primKey.name),
                    range: k,
                    keysOnly: !1,
                    dir: 'next',
                    unique: '',
              ...
              (this.Table =
                ((w = this),
                Dr(Jc.prototype, function (S, R, k) {
                  ;(this.db = w),
                    (this._tx = k),
                    (this.name = S),
                    (this.schema = R),
                    (this.hook = w._allTables[S]
                      ? w._allTables[S].hook
                      : Kr(null, { creating: [vd, pt], reading: [_e, ce], updating: [xd, pt], deleting: [Ed, pt] }))
                }))),
              (this.Transaction =
                ((E = this),
                Dr(Ud.prototype, function (S, R, k, N, $) {
                  var _ = this
                  ;(this.db = E),
                    (this.mode = S),
                    (this.storeNames = R),
                    ...
                    (this.idbtrans = null),
                    (this.on = Kr(this, 'complete', 'error', 'abort')),
                    (this.parent = $ || null),
                    (this.active = !0),
                    (this._reculock = 0),
                    (this._blockedFuncs = []),
                    ...
                    (this._spinCount = 0),
                    (this._completion = new rt(function (L, K) {
                    ...
                    this._completion.then(
                      ...
                      function (L) {
                        ...
                        return (
                          (_.active = !1),
                          _.on.error.fire(L),
                          _.parent ? _.parent._reject(L) : K && _.idbtrans && _.idbtrans.abort(),
                          Ht(L)
                        )
                      },
                    )
              ...
              (this.Version =
                ((x = this),
                Dr(Dd.prototype, function (S) {
                  ;(this.db = x),
                    (this._cfg = { version: S, storesSource: null, dbschema: {}, tables: {}, contentUpgrade: null })
                }))),
              (this.WhereClause =
                ((A = this),
                Dr(ou.prototype, function (S, R, k) {
                  if (
                    ((this.db = A),
                    (this._ctx = { table: S, index: R === ':id' ? null : R, or: k }),
                    (this._cmp = this._ascending = At),
                    (this._descending = function (N, $) {
                      return At($, N)
                    }),
              ...
              this.on('blocked', function (S) {
                !S.newVersion || S.newVersion < S.oldVersion
                  ? console.warn("Dexie.delete('".concat(l.name, "') was blocked"))
                  : console.warn(
                      "Upgrade '"
                        .concat(l.name, "' blocked by other connection holding version ")
                        .concat(S.oldVersion / 10),
                    )
              }),
              (this._maxKey = Vr(a.IDBKeyRange)),
              (this._createTransaction = function (S, R, k, N) {
          ...
          var ei,
            Ue = typeof Symbol < 'u' && 'observable' in Symbol ? Symbol.observable : '@@observable',
            Wd =
              ((Hs.prototype.subscribe = function (i, a, l) {
                ...
                var S = !1,
                  ...
                  N = function () {
                    ...
                    !x &&
                      ...
                      })((_ = { subscr: $, signal: E.signal, requery: R, querier: i, trans: null }))),
                      Promise.resolve(L).then(
                        ...
                        function (K) {
                          ;(l = !1),
                            ['DatabaseClosedError', 'AbortError'].includes(K == null ? void 0 : K.name) ||
                              x ||
                              ys(function () {
                                x || (p.error && p.error(K))
                              })
          ...
          m(
            ...
            r(r({}, le), {
                ...
                try {
                  return (
                    ...
                    (Ns(l)
                      ...
                      : _s(l, a).toCollection().primaryKeys()
                    ).then(i)
                  )
                } catch {
              ...
              waitFor: function (i, a) {
                return (
                  (a = rt.resolve(typeof i == 'function' ? qn.ignoreTransaction(i) : i).timeout(a || 6e4)),
                  ut.trans ? ut.trans.waitFor(a) : a
                )
              },
              Promise: rt,
              debug: {
            ...
            (qn.maxKey = Vr(qn.dependencies.IDBKeyRange)),
          ...
          return (
            typeof BroadcastChannel < 'u' &&
              ...
              typeof ur.unref == 'function' && ur.unref(),
              xn(Fr, function (i) {
                Sn || ur.postMessage(i)
              })),
            typeof addEventListener < 'u' &&
              ...
              addEventListener('pageshow', function (i) {
                !on.disableBfCache &&
                  i.persisted &&
                  (ze && console.debug('Dexie: handling persisted pageshow'), vu(), Fs({ all: new de(-1 / 0, [[]]) }))
              })),
...
var rw = nw()
const Ya = /* @__PURE__ */ Tg(rw),
  Lf = Symbol.for('Dexie'),
  ji = globalThis[Lf] || (globalThis[Lf] = Ya)
...
const {
  ...
  Wn = new ji('arkade', { allowEmptyDB: !0 })
Wn.version(1).stores({
...
self.addEventListener('activate', (t) => {
  t.waitUntil(
    caches.keys().then((e) =>
      Promise.all(
        e.map((n) => {
          if (n !== Hc) return caches.delete(n)
        }),
      ),
    ),
  ),
